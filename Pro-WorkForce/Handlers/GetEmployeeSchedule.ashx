<%@ WebHandler Language="VB" Class="GetEmployeeSchedule" %>
...
Public Class GetEmployeeSchedule : Implements IHttpHandler, IRequiresSessionState
    ...
    Private Function gets(ByVal lstScheduleJSON As List(Of ScheduleJSON)) As DataTable
        ...
        Dim ScheduleXml As New WebControls.Xml
	...
	Private Sub GetScheduleXML(ByVal context As HttpContext)
		...
		JSON = "[{""employees"":" + objEmp_WorkSchedule.GetAllEmployees_JSON(Month, Year, scheduleId) + ", " + """schedule"":" + objEmp_Shifts.GetByDate_JSON(Year, Month) + "}]"

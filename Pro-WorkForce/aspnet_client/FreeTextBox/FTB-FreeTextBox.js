 	...
 	switch (this.pasteMode) {
 		...
 		case FTB_PASTE_TEXT:
 			if (window.clipboardData) {
				...
				this.InsertHtml(text);
 			    ...
 			    ShowMessage("Your browser does not support pasting rich content");
			}
			return false; 				
 		default:
 		case FTB_PASTE_DEFAULT:
			try {
			    ...
			    ShowMessage('Your security settings to not allow you to use this command.  Please visit http://www.mozilla.org/editor/midasdemo/securityprefs.html for more information.');
			}	
 			return true;
 	}		
};

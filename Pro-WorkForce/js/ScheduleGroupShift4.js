...
function GetData() {
    ...
    var Url = "../Handlers/GetEmployeeSchedule4.ashx?year=" + year + "&month=" + month + "&schedule=" + SelectedSchedule_Global + "&r=" + Math.random().toString();
...
function PostData() {
    if (scheduleJSON) {
        ...
        if (dataToPost) {
            ...
            var Url = "../Handlers/GetEmployeeSchedule4.ashx?year=" + year + "&month=" + month + "&schedule=" + SelectedSchedule_Global;
...
function RemoveSchedule(year, month, day, EmpID, td) {
    if (rightButtonDown) {
        ...
        if ((new Date(year, month - 1, day).getDay() == 6) || new Date(year, month - 1, day).getDay() == 5) {
            td.style.backgroundColor = '#FFFFFF'; //#ccc WeekEnds To Be Gray
        } else {
            ...
            if (!!scheduleJSON) {
                ...
                if (!!existing) {
                    ...
                    if ((new Date(year, month - 1, j).getDay() == 5) || (new Date(year, month - 1, j).getDay() == 6)) {
                        ...
                        td_b.style.backgroundColor = '#FFFFFF'; //#ccc WeekEnds To Be Gray

...
function GetData(FilterOption) {
    ...
    var Url = "../Handlers/GetEmployeeScheduleRequest.ashx?year=" + year + "&month=" + month + "&schedule=" + SelectedSchedule_Global + "&r=" + Math.random().toString() + "&FilterOption=" + FilterOption;
...
function PostData() {
    if (scheduleJSON) {
        ...
        if (dataToPost) {
            ...
            var Url = "../Handlers/GetEmployeeScheduleRequest.ashx?year=" + year + "&month=" + month + "&schedule=" + SelectedSchedule_Global;

...
//            }
             if (AffectedRows > 0) {
                var UICulture = document.getElementById("ctl00_ContentPlaceHolder1_hdnUICulture");
                if (UICulture.value == "ar-JO") {
                    ShowMessage_Success('تم الحفظ بنجاح'); //ShowMessage('AffectedRows: ' + AffectedRows);
                } else {
                    ShowMessage_Success('Saved Successfully'); //ShowMessage('AffectedRows: ' + AffectedRows);
                }
            }
            ...
            for (var j = 1; j <= new Date(year, month, 0).getDate(); j++) {
                ...
                if (!!existingLeave) {
                    if (existingLeave[0].LeaveTypeId == 68) {
                        setInnerText(td_b, '<img src=../images/sick.png width=12 height=12 />');
                    }
                    else if (existingLeave[0].LeaveTypeId == 0) {
                        setInnerText(td_b, '<img src=../images/Holiday.png width=12 height=12 />');
                    }
                    else {
                        setInnerText(td_b, '<img src=../images/annual1.png width=12 height=12 />');
                    }

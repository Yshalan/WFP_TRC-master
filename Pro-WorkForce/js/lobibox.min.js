...
! function () {
    ...
    function LobiboxPrompt(type, options) {
        this.$input = null, this.$type = "prompt", this.$promptType = type, options = $.extend({}, Lobibox.prompt.DEFAULT_OPTIONS, options),
            this.$options = this._processInput(options), this._init(), this.debug(this)
    }
    ...
    Lobibox.counter = 0, Lobibox.prompt = function (type, options) {
        ...
        Lobibox.error = {}, Lobibox.success = {}, Lobibox.warning = {}, Lobibox.info = {},
    ...
    var LobiboxBase = {
        ...
        _processInput: function (options) {
            ...
            return options = $.extend({}, Lobibox.base.DEFAULTS, options),
                ...
                options.iconClass || (options.iconClass = Lobibox.base.OPTIONS.icons[options.iconSource][this.$type]), options
        },
        _init: function () {
            var me = this;
        ...
        _createButton: function (type, op) {
            ...
            return me.$options.callback && "function" == typeof me.$options.callback && btn.on("click.lobibox", function (ev) {
                var bt = $(this);
                me._onButtonClick(me.$options.buttons[type], type), me.$options.callback(me, bt.data("type"), ev) //A_I_S
            }), btn.click(function () {

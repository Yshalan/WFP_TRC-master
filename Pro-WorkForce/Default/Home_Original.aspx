<%@ Page Language="VB" Title="Pro-WorkForce" AutoEventWireup="false" CodeFile="Home_Original.aspx.vb" Theme="Default"
    Inherits="Default_Home" %>
    ...
    <form id="form1" runat="server">
        ...
        <header>
            ...
            <a class="navbar-brand" href="../default/home.aspx">
                ...
                <asp:Image ImageUrl="../assets/img/WF-logo.png" runat="server" ToolTip="Home Page" Height="42px" Width="216px" />
            </a>
                ...
                <ul>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <asp:Image ID="Image2" ImageUrl="../assets/img/icn_edit.png" runat="server" ToolTip="Choose Your Theme" />
                        </a>
                    ...
                    <li>
                        <asp:LinkButton ID="lnkbtnLanguage" runat="server">
                            <asp:Image ID="ImgLanguage" ImageUrl="../assets/img/ArBt.png" runat="server" ToolTip="Change Language to Arabic" />
                        </asp:LinkButton>
                    </li>
                    <li>
                        <asp:LinkButton ID="lnkbtnLogOut" runat="server">
                            <asp:Image ID="ImgLogOut" ImageUrl="../assets/img/icn_logout.png" runat="server" ToolTip="Log Out" />
                        </asp:LinkButton>
                    </li>
                </ul>
            </div>
                    ...
                    <ul>
                        <asp:Repeater ID="repAnnouncement" runat="server">
                            <ItemTemplate>
                                <li>
                                    <span class="date">
                                        <asp:Label ID="lblMonth" runat="server" Text='<%# Eval("MonthEnglish")%>' />
                                    ...
                                    <span class="description">
                                        ...
                                        <asp:LinkButton ID="lnkDescription" Text='<%# Eval("Title_En")%>' OnClientClick='<%# Eval("ID", "openRadWin({0});return false;") %>' runat="server" />
                                    </span>

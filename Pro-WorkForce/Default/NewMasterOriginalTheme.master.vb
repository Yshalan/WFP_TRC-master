...
Partial Class Default_NewMaster
...
#Region "Page Events"
    ...
    Protected Sub lbtnHR_2_3_10_Click(sender As Object, e As EventArgs) Handles lbtnHR_2_3_10.Click

<%@ Page Title="" Language="VB" MasterPageFile="~/Default/ArabicMaster.master" AutoEventWireup="false" Theme="SvTheme"
    CodeFile="Homearabic.aspx.vb" Inherits="Default_ArabicTheme2" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-4 StatusCount_container">
            ...
            <div id="ViolationSummary_container"  class="highchartsalignment"></div>
        </div>
    </div>

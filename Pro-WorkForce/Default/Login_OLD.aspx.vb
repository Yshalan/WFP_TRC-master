...
#Region "Methods"
    ...
    Function AuthenticateUser(user As String, pass As String) As Boolean
        ...
        Try
            ...
            Dim strDomain As String = GetCurrentDomainPath()
            Dim dsDirectoryEntry As New DirectoryEntry("LDAP://smart-v.local", user, pass, AuthenticationTypes.Secure)
            '"UserDomainName": "SAIT-DC01.sait.local"
    ...
    Function GetCurrentDomainPath() As String


        Dim de As New DirectoryEntry("LDAP://RootDSE")
        Dim domainAndUserName As String = Domain.GetComputerDomain().ToString()
        Dim d As String = "LDAP://" + de.Properties("defaultNamingContext")(0).Value.ToString
        Return d
                    ...
                    If chkUsePC.Checked Then
                        ...
                        Try
                            If Not AuthenticateUser(txtUserName.Text, txtPassword.Text) Then
                                CtlCommon.ShowMessage(Me.Page, "Please Enter an Active Directory User")
                            End If

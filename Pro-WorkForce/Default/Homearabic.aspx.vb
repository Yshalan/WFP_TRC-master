...
Partial Class Default_ArabicTheme2
...
#Region "Methods"
    ...
    Private Sub FillPermissionRequestCountDash()
        ...
        JSONPermissionRequestCountChartTitleText.Text = "<script type='text/javascript' charset='utf-8'>var Var_PermissionRequestCountChartTitleText = '" & IIf(Lang = CtlCommon.Lang.AR, " طلبات المغادرة ", "Permission <br> Request") & "'</Script>"

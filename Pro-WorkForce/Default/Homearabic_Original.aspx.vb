...
Partial Class Default_HomeArabic
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            FillModules()
            FillData()
            lblCopyRight.Text = objSmartSecurity.strSmartDecrypt(ConfigurationManager.AppSettings("CopyRightAr").ToString(), "SmartVision")
    ...
    Protected Sub repAnnouncement_ItemDataBound(ByVal source As Object, ByVal e As RepeaterItemEventArgs)
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If SessionVariables.CultureInfo = "ar-JO" Then
                ...
                lblMonth.Text = GetNames.DateTimeFormat.GetMonthName(monthNo).ToString()
            Else
                lblMonth.Text = CultureInfo.CurrentUICulture.DateTimeFormat.GetMonthName(monthNo).ToString()
            End If

...
Imports TA.LookUp
Partial Class SelfServices_ManualEntryRequest_Remote
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            ElseIf SessionVariables.CultureInfo = "ar-JO" Then
                Lang = CtlCommon.Lang.AR
                txtremarks.Text = "العمل عن بعد"
            Else
                Lang = CtlCommon.Lang.EN
                txtremarks.Text = "Remote Attendance"
            End If
            ...
            EmpManualEntryRequest.HeaderText = ResourceManager.GetString("RemoteAttendance", CultureInfo)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim err As Integer
        Dim IsAutoApproveRequest As Boolean = True
        ...
        objEmp_MoveRequest.IsRemoteWork = True
        If Not fuAttachFile.PostedFile Is Nothing Then
        ...
        If err = 0 Then
            ...
            If IsAutoApproveRequest = True Then
                If Lang = CtlCommon.Lang.AR Then
                    ScriptManager.RegisterStartupScript(Me, Page.GetType, "Redirect", "ShowMessageAndRedirect('تم الموافقة على الطلب بشكل تلقائي','../SelfServices/ManualEntryRequest_Remote.aspx');", True)
                Else
                    ScriptManager.RegisterStartupScript(Me, Page.GetType, "Redirect", "ShowMessageAndRedirect('The Request has been Automatically Approved','../SelfServices/ManualEntryRequest_Remote.aspx');", True)
                End If

            Else
                If Lang = CtlCommon.Lang.AR Then
                    ScriptManager.RegisterStartupScript(Me, Page.GetType, "Redirect", "ShowMessageAndRedirect('تم إرسال الطلب الى المدير المباشر','../SelfServices/ManualEntryRequest_Remote.aspx');", True)
                Else
                    ScriptManager.RegisterStartupScript(Me, Page.GetType, "Redirect", "ShowMessageAndRedirect('The Request has been Sent to Direct Manager','../SelfServices/ManualEntryRequest_Remote.aspx');", True)
                End If
            End If
    ...
    Protected Sub dgrdManualEntryRequest_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdManualEntryRequest.NeedDataSource
        ...
        dtCurrent = objEmp_MoveRequest.GetFilter_Remote()
    ...
    Protected Sub btnCancel_Click(sender As Object, e As System.EventArgs) Handles btnCancel.Click
        Response.Redirect("../SelfServices/ManualEntryRequest_Remote.aspx?Id=1")
    End Sub
...
#Region "Methods"
    ...
    Private Sub FillReasons()
        objTA_Reason = New TA_Reason()
        CtlCommon.FillTelerikDropDownList(ddlReason, objTA_Reason.GetAll_Remote, Lang)
    End Sub
    ...
    Protected Sub btnGet_Click(sender As Object, e As System.EventArgs) Handles btnGet.Click
        ...
        objEmp_MoveRequest.FromDate = dtpFromDateSearch.SelectedDate
        objEmp_MoveRequest.ToDate = dtpToDateSearch.SelectedDate
        dgrdManualEntryRequest.DataSource = objEmp_MoveRequest.GetFilter_Remote()
        dgrdManualEntryRequest.DataBind()
    End Sub
    ...
    Private Sub SaveManualEntry()
        ...
        If (File.Exists(Server.MapPath("~\ManualEntryRequestFiles\\" + MoveRequestId.ToString() + FileExtension))) Then
            ...
            If (File.Exists(Server.MapPath("~\ManualEntryRequestFiles\\" + objEmp_MoveRequest.MoveRequestId.ToString() + FileExtension))) Then
                Dim CopyFile As FileInfo = New FileInfo(Server.MapPath("~\ManualEntryRequestFiles\\" + objEmp_MoveRequest.MoveRequestId.ToString() + FileExtension))
                CopyFile.CopyTo(Server.MapPath("~\ManualEntryFiles\\" + MoveId.ToString() + FileExtension))
            End If
    ...
    Private Sub ddlReason_SelectedIndexChanged(sender As Object, e As RadComboBoxSelectedIndexChangedEventArgs) Handles ddlReason.SelectedIndexChanged
        objTA_Reason = New TA_Reason
        If Not ddlReason.SelectedValue = -1 Then
            objTA_Reason.ReasonCode = ddlReason.SelectedValue
            objTA_Reason.GetByPK()
            If objTA_Reason.Type = "O" Then
                dvAttachment.Visible = True
            Else

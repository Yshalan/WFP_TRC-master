<%@ Page Title="" Language="VB" MasterPageFile="~/Default/NewMaster.master" AutoEventWireup="false" Theme="SvTheme"
    CodeFile="ManualEntryRequest_Remote.aspx.vb" Inherits="SelfServices_ManualEntryRequest_Remote" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript" language="javascript">
        function RefreshPage() {
            window.location = "../SelfServices/ManualEntryRequest_Remote.aspx";
        }
    ...
    <uc1:PageHeader ID="EmpManualEntryRequest" runat="server" HeaderText="Remote Work" />
    <asp:MultiView ID="mvEmpLeaverequest" runat="server">
        <asp:View ID="viewManualEntryRequests" runat="server">
            <div class="row">
                ...
                <div class="col-md-4">
                    <telerik:RadComboBox ID="ddlStatus" AutoPostBack="True" runat="server" MarkFirstMatch="True" Enabled="False" meta:resourcekey="ddlStatusResource1">
                    </telerik:RadComboBox>
        ...
        <asp:View ID="viewAddManualEntryRequest" runat="server">
            ...
            <div class="row">
                <div class="col-md-2">
                    <asp:Label ID="lblReason" runat="server" CssClass="Profiletitletxt" meta:resourcekey="lblReasonResource1" Text="Transaction Type"></asp:Label>
                </div>
                <div class="col-md-4">
                    <telerik:RadComboBox ID="ddlReason" runat="server" MarkFirstMatch="True" AppendDataBoundItems="True" AutoPostBack="true"
            ...
            <div class="row" id="dvAttachment" runat="server" visible="false">
                <div class="col-md-2">

<%@ Page Title="" Language="VB" MasterPageFile="~/Default/NewMaster.master" AutoEventWireup="false"
    CodeFile="EmployeeGoals_byCoordinator.aspx.vb" Inherits="Appraisal_EmployeeGoals_byCoordinator"
    Theme="SvTheme" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <uc1:PageHeader ID="PageHeader1" HeaderText="Employees Goals" runat="server" />

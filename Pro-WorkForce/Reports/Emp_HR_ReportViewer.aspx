<%@ Page Title="" Language="VB" MasterPageFile="~/Default/NewMaster.master" AutoEventWireup="false"  Theme="SvTheme"
    CodeFile="Emp_HR_ReportViewer.aspx.vb" Inherits="Reports_Emp_HR_ReportViewer"
    ...
    <asp:multiview id="MultiView1" runat="server" activeviewindex="0">
        <asp:view id="Filter" runat="server">
          <%--  <center>
            ...
            <div class="row">
                <div class="col-md-12">
                    <uc2:EmployeeFilter ID="EmployeeFilter1" runat="server" ShowRadioSearch="true" ShowDirectStaffCheck="true" ValidationGroup="btnPrint"/>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <telerik:RadComboBox ID="RadCmbBxReports" CausesValidation="False" Filter="Contains"
                        AutoPostBack="True" MarkFirstMatch="True" Skin="Vista" runat="server" Style="width: 350px"
                        meta:resourcekey="RadCmbBxReportsResource1">
                    </telerik:RadComboBox>

                    <asp:RequiredFieldValidator ID="rfvReports" runat="server" ControlToValidate="RadCmbBxReports"
                        Display="None" ErrorMessage="Please Select Report" ValidationGroup="Save" meta:resourcekey="rfvReportsResource1">
                    </asp:RequiredFieldValidator>
                    <cc1:ValidatorCalloutExtender ID="vceReports" runat="server" Enabled="True" TargetControlID="rfvReports">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="RadDatePicker1"
                        Display="None" ErrorMessage="Please Select Date" ValidationGroup="Save" meta:resourcekey="RequiredFieldValidator9Resource1">
                    </asp:RequiredFieldValidator>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="RadDatePicker2"
                        Display="None" ErrorMessage="Please Select Date" ValidationGroup="Save" meta:resourcekey="RequiredFieldValidator1Resource1">
                    </asp:RequiredFieldValidator>
                    ...
                    <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToCompare="RadDatePicker1"
                        ...
                        Operator="GreaterThanEqual" Type="Date" ValidationGroup="Save" meta:resourcekey="CompareValidator2Resource1">
            ...
            <div id="trControls" runat="server" class="row">
                <div class="col-md-2"></div>
                <div id="Td2" runat="server" class="col-md-1">

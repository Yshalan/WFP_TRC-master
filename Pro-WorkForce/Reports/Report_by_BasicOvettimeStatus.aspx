<%@ Page Title="Overtime Report" Language="VB" AutoEventWireup="false" MasterPageFile="~/Default/ArabicMaster.master"
    EnableEventValidation="false" CodeFile="Report_by_BasicOvettimeStatus.aspx.vb"  StylesheetTheme="Default"
    Inherits="Reports_Report_by_OvettimeStatus" UICulture="auto" meta:resourcekey="PageResource1" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="RadDatePicker1"
                                                        Display="None" ErrorMessage="Please Select Date" ValidationGroup="Grpfind" meta:resourcekey="RequiredFieldValidator9Resource1"></asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="RadDatePicker2"
                                                        Display="None" ErrorMessage="Please Select Date" ValidationGroup="Grpfind" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator>

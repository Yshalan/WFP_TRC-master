...
#Region "Class Variables"
    ...
    Private objRequestStatus As TA.Lookup.RequestStatus
...
#Region "Page Events"
    ...
    Protected Sub Reports_Report_by_OvettimeStatus_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            lblReportTitle.HeaderText = IIf(Lang = CtlCommon.Lang.AR, "تقرير الوقت الاضافي", "Overtime Report")
...
#Region "Methods"
    ...
    Private Sub FillExcelreport()
        ...
        If (Lang = CtlCommon.Lang.AR) Then
            ...
            'NDT.Columns(10).ColumnName = "المدة الموافق عليها"
            'NDT.Columns(11).ColumnName = "من تاريخ"
            'NDT.Columns(12).ColumnName = "الى تاريخ"
            'NDT.Columns(13).ColumnName = "وقت عالي"
            'Else
        ...
        Else
            ...
            'If objAPP_Settings.AllowEditOverTime = True Then
            '    NDT.Columns(10).ColumnName = "Approved Duration"
            '    NDT.Columns(11).ColumnName = "From Date"
            '    NDT.Columns(12).ColumnName = "To Date"
            '    NDT.Columns(13).ColumnName = "High Time"
            'Else
            NDT.Columns.RemoveAt(10)

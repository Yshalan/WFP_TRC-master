<%@ Page Title="" Language="VB" MasterPageFile="~/Default/ReportMaster.master"  StylesheetTheme="Default" AutoEventWireup="false"
    CodeFile="EntityTOTHRS_Viewer.aspx.vb" Inherits="Reports_EntityTOTHRS_Viewer" %>
...
<%@ Register Src="../Admin/UserControls/UserSecurityFilter.ascx" TagName="EmployeeFilter"
    TagPrefix="uc1" %>
                                ...
                                <tr>
                                    <td>
                                        <table style="background-color: #fff">
                                            <tr>
                                                <td colspan="3">
                                                    <uc1:EmployeeFilter ID="EmployeeFilter1" runat="server" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="130px">
                                                    <asp:Label ID="lblFromDate" runat="server" CssClass="Profiletitletxt" Text="From Date"></asp:Label>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="RadDatePicker1"
                                                        Display="None" ErrorMessage="Please Select Date" ValidationGroup="btnPrint"></asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToCompare="RadDatePicker1"
                                                        ...
                                                        Operator="GreaterThanEqual" Type="Date" ValidationGroup="btnPrint"></asp:CompareValidator>
                                            ...
                                            <tr id="trControls" runat="server" align="center">
                                                ...
                                                <td>
                                                    <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="button" ValidationGroup="btnPrint" />
                                                </td>
                                                <td>
                                                </td>
                                            </tr>

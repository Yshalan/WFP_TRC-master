<%@ Page Title="" Language="VB" MasterPageFile="~/Default/ReportMaster.master" AutoEventWireup="false"  StylesheetTheme="Default"
    CodeFile="Emp_DetailsReport_ByType.aspx.vb" Inherits="Reports_Emp_DetailsReport_ByType"
                                ...
                                <tr>
                                    <td>
                                        <table style="background-color: #fff">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:label id="lblType" runat="server" cssclass="Profiletitletxt" text="Employee Type"
                                                        meta:resourcekey="lblTypeResource1"></asp:label>
                                                </td>
                                                <td>
                                                    <telerik:RadComboBox ID="ddlType" runat="server" AppendDataBoundItems="True" Width="200px"
                                                        MarkFirstMatch="True" AutoPostBack="True" Skin="Vista" meta:resourcekey="ddlTypeResource1" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="130px">

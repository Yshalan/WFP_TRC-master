<%@ Page Language="VB"  StylesheetTheme="Default" MasterPageFile="~/Default/EmptyMaster.master"
    AutoEventWireup="false" CodeFile="AssignEmployee.aspx.vb" Inherits="Admin_AssignEmployee"
    UICulture="auto" Theme="SvTheme" Culture="auto" meta:resourcekey="PageResource3" %>
...
<asp:UpdatePanel ID="upEmpFilter" runat="server">
    <ContentTemplate>
        ...
        <div class="row">
            ...
            <%--    <asp:Button ID="Button1" runat="server" CssClass="button" Text="Assign"
                ...
                <asp:Button ID="btnAssignEmployee" runat="server" CssClass="button" Text="Assign" 
                    CausesValidation="False" meta:resourcekey="btnAssignEmployeeResource1" ValidationGroup ="validateEmployeeComp"/>

                <asp:RequiredFieldValidator ID="rvfBtnAssign" runat="server" ControlToValidate="TxtEmpNo"
                    Display="None" ErrorMessage="Please Select Employee" Enabled="true" meta:resourcekey="rfvEmployeeResource1"></asp:RequiredFieldValidator>
                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" CssClass="AISCustomCalloutStyle"
                    TargetControlID="rvfBtnAssign" WarningIconImageUrl="~/images/warning1.png" Enabled="True">
                </cc1:ValidatorCalloutExtender>

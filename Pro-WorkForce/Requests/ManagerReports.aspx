<%@ Page Title="" Language="VB" MasterPageFile="~/Default/NewMaster.master" AutoEventWireup="false"
    CodeFile="ManagerReports.aspx.vb" Inherits="Requests_ManagerReports" %>
                                    ...
                                    <td>
                                        <table style="background-color: #fff">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadComboBox ID="RadCmbBxReports" AllowCustomText="false" MarkFirstMatch="true"
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvReports" runat="server" ControlToValidate="RadCmbBxReports"
                                                        InitialValue="--Please Select--" Display="None" ErrorMessage="Please Select Report"
                                                        ValidationGroup="Save">
                                                    </asp:RequiredFieldValidator>
                                                    <cc1:ValidatorCalloutExtender ID="vceReports" runat="server" CssClass="AISCustomCalloutStyle"
                                                        TargetControlID="rfvReports" WarningIconImageUrl="~/images/warning1.png" Enabled="True">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="RadDatePicker1"
                                                        Display="None" ErrorMessage="Please Select Date" ValidationGroup="Save">
                                                    </asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                <td width="138px">
                                                    <asp:Label ID="lblToDate" runat="server" CssClass="Profiletitletxt" Text="To Date"></asp:Label>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToCompare="RadDatePicker1"
                                                        ...
                                                        Operator="GreaterThanEqual" Type="Date" ValidationGroup="Save">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RadioButtonList ID="rblFormat" runat="server" RepeatDirection="Horizontal" CssClass="Profiletitletxt">
                                                        ...
                                                        <asp:ListItem Text="MS Word" Value="2">
                                                        </asp:ListItem>
                                                        <asp:ListItem Text="MS Excel" Value="3">
                                                        </asp:ListItem>
                                                    </asp:RadioButtonList>

...
Partial Class Requests_UserControls_GM_GM_StudyPermissionApproval
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                MsgLang = "en"
            End If
            lblStudyPermissionRequests.Text = ResourceManager.GetString("GeneralMgrStudyPermitHeader", CultureInfo)
            Page.Title = "Work Force Pro : :" + ResourceManager.GetString("GeneralMgrStudyPermitHeader", CultureInfo)
            ShowHideControls()
            FillGridView()
        End If
    End Sub
    ...
    Protected Sub lnkAccept_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        With objAPP_Settings
            .GetByPK()
            If (.StudyPermissionApproval = 4) Then
    ...
    Protected Sub dgrdEmpHR_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdEmpLeaveRequest.NeedDataSource
        ...
        objEmp_Study_PermissionRequest.FK_StatusId = RequestStatus.ApprovedByHR
        dtCurrent = objEmp_Study_PermissionRequest.GetByGeneralManager()
...
#Region "Methods"
    ...
    Public Sub FillGridView()
        Try
            ...
            objEmp_Study_PermissionRequest = New Emp_Study_PermissionRequest()
            objEmp_Study_PermissionRequest.FK_StatusId = RequestStatus.ApprovedByHR
            dtPermissionRequest = objEmp_Study_PermissionRequest.GetByGeneralManager()

...
Partial Class Requests_UserControls_GM_GM_ManualEntryApproval
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            lblManualEntryRequests.Text = ResourceManager.GetString("GeneralMgrManualEntryHeader", CultureInfo)
            Page.Title = "Work Force Pro : :" + ResourceManager.GetString("GeneralMgrManualEntryHeader", CultureInfo)
            ShowHideControls()
            FillGridView()
        End If
    End Sub
    ...
    Protected Sub dgrdManualEntryRequest_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdManualEntryRequest.NeedDataSource
        ...
        objEmp_MoveRequest.Status = RequestStatus.ApprovedByHR
        dtCurrent = objEmp_MoveRequest.GetByGeneralManager()
...
#Region "Methods"
    ...
    Public Sub FillGridView()
        Try
            ...
            objEmp_MoveRequest.FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
            objEmp_MoveRequest.Status = RequestStatus.ApprovedByHR
            dtManualEntryRequets = objEmp_MoveRequest.GetByGeneralManager()

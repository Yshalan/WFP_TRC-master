<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GM_ManualEntryApproval.ascx.vb"
    Inherits="Requests_UserControls_GM_GM_ManualEntryApproval" %>
    ...
    <ContentTemplate>
        ...
        <div class="table-responsive">
            ...
            <telerik:RadGrid ID="dgrdManualEntryRequest" runat="server" AllowSorting="True" AllowPaging="True"
                ...
                meta:resourcekey="dgrdManualEntryRequestResource1">

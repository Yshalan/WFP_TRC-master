...
Partial Class Requests_UserControls_GM_GM_UpdateTransactionApproval
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            lblManualEntryRequests.Text = ResourceManager.GetString("GeneralUpdateTransactionHeader", CultureInfo)
            Page.Title = "Work Force Pro : :" + ResourceManager.GetString("GeneralUpdateTransactionHeader", CultureInfo)
            ShowHideControls()
            FillGridView()
        End If
    End Sub
    ...
    Protected Sub lnkAccept_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If (objAPP_Settings.LeaveApproval = 4) Then
            ...
            Dim MoveId As String = DirectCast(DirectCast(sender, LinkButton).Parent.Parent, GridDataItem).GetDataKeyValue("MoveId").ToString()
            Dim Remarks As String = String.Empty
            Dim UpdateTransactionType As String = DirectCast(DirectCast(sender, LinkButton).Parent.Parent, GridDataItem).GetDataKeyValue("UpdateTransactionType").ToString()
            ...
            With objEmp_MoveUpdateRequest
                ...
                .GetByPK()
                .Status = Convert.ToInt32(RequestStatus.ApprovedByGM).ToString
                .LAST_UPDATE_BY = SessionVariables.LoginUser.ID
                .FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
                Err = .UpdateManualRequestStatus()

                Dim err_Update As Integer = -1
                objEmp_Move.MoveId = .MoveId
                objEmp_Move.Type = .Type
                objEmp_Move.FK_ReasonId = .FK_ReasonId
                objEmp_Move.Remarks = .Remarks
                ...
                If (File.Exists(Server.MapPath("~\UpdateTransactionsRequestFiles\\" + MoveRequestId.ToString() + AttachedFile))) Then
                    'My.Computer.FileSystem.RenameFile(Server.MapPath("~\UpdateTransactionsRequestFiles\\" + MoveRequestId.ToString() + AttachedFile), _
                    '                                  (objEmp_MoveUpdateRequest.MoveRequestId.ToString() + AttachedFile).ToString())

                    If (File.Exists(Server.MapPath("~\UpdateTransactionsRequestFiles\\" + objEmp_MoveUpdateRequest.MoveRequestId.ToString() + AttachedFile))) Then
                        Dim CopyFile As FileInfo = New FileInfo(Server.MapPath("~\UpdateTransactionsRequestFiles\\" + objEmp_MoveUpdateRequest.MoveRequestId.ToString() + AttachedFile))
                        CopyFile.CopyTo(Server.MapPath("~\ManualEntryFiles\\" + objEmp_MoveUpdateRequest.MoveRequestId.ToString() + AttachedFile))
                    End If
                    ...
                    Else
                        If Not MoveDate > Date.Today Then
                            ...
                            With objRecalculateRequest
                                ...
                                .Remarks = "Update Transaction Request Approval - SYSTEM"
                                err2 = .Add
                            End With
                        End If
                    End If
    ...
    Protected Sub lnkReject_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReject.Click
        ...
        With objEmp_MoveUpdateRequest
            ...
            .GetByPK()
            .Status = RequestStatus.RejectedByGM
    ...
    Protected Sub dgrdUpdateTransactionRequest_OnRowCommand(ByVal sender As Object, ByVal e As GridCommandEventArgs) Handles dgrdUpdateTransactionRequest.ItemCommand
    ...
    Protected Sub dgrdUpdateTransactionRequest_ItemDataBound(ByVal sender As Object, ByVal e As GridItemEventArgs) Handles dgrdUpdateTransactionRequest.ItemDataBound
    ...
    Protected Sub dgrdUpdateTransactionRequest_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdUpdateTransactionRequest.NeedDataSource

        objEmp_MoveUpdateRequest = New Emp_MoveUpdateRequest()
        objEmp_MoveUpdateRequest.FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
        objEmp_MoveUpdateRequest.Status = RequestStatus.ApprovedByHR
        dtCurrent = objEmp_MoveUpdateRequest.GetByGeneralManager()
        Dim dv As New DataView(dtCurrent)
        dv.Sort = SortExepression
        dgrdUpdateTransactionRequest.DataSource = dv
...
#Region "Methods"
    ...
    Public Sub FillGridView()
        Try
            ...
            objEmp_MoveUpdateRequest.FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
            objEmp_MoveUpdateRequest.Status = RequestStatus.ApprovedByHR
            dtManualEntryRequets = objEmp_MoveUpdateRequest.GetByGeneralManager()
            dgrdUpdateTransactionRequest.DataSource = dtManualEntryRequets
            dgrdUpdateTransactionRequest.DataBind()
...
#Region "Grid Filter"
    ...
    Protected Function GetFilterIcon() As String
        Return RadAjaxLoadingPanel.GetWebResourceUrl(Page, String.Format("Telerik.Web.UI.Skins.{0}.Grid.Filter.gif", dgrdUpdateTransactionRequest.Skin))
    End Function
...
#Region "Proceed All"
    ...
    Protected Sub btnProceed_Click(sender As Object, e As System.EventArgs) Handles btnProceed.Click
        ...
        For Each item As GridDataItem In dgrdUpdateTransactionRequest.Items
    ...
    Private Sub AcceptAll(ByVal item As GridDataItem, ByRef ErrNo As Integer, ByRef Msg As String)
        ...
        If (objAPP_Settings.LeaveApproval = 4) Then
            ...
            Dim Remarks As String = String.Empty
            Dim UpdateTransactionType As String = item.GetDataKeyValue("UpdateTransactionType").ToString()

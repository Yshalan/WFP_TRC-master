<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GM_LeaveApproval.ascx.vb"
    Inherits="Requests_UserControls_GM_GM_LeaveApproval" %>
        ...
        <div class="row">
            <div class="col-md-4">
                <asp:Label ID="lblLeaveRequests" runat="server"
                    Text="Leave Requests" CssClass="Profiletitletxt" meta:resourcekey="lblLeaveRequestsResource1" />
            ...
            <asp:View ID="viewGMApproval" runat="server">
                <div class="table-responsive">
                    ...
                    <telerik:RadGrid ID="dgrdEmpLeaveRequest" runat="server" AllowSorting="True" AllowPaging="True"
                        ...
                        <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="FromDate,ToDate,LeaveId,AttachedFile,LeaveTypeId,HasAdvancedSalary,FK_EmployeeId,Requestdate,Remarks">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="AttachedFile" Visible="False"
                                    meta:resourcekey="GridBoundColumnResource7" UniqueName="AttachedFile" />

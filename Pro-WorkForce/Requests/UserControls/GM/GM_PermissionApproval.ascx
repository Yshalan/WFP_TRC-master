<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GM_PermissionApproval.ascx.vb"
    Inherits="Requests_UserControls_GM_GM_PermissionApproval" %>
            ...
            <asp:View ID="viewGMApproval" runat="server">
                <div class="table-responsive">
                    ...
                    <telerik:RadGrid ID="dgrdEmpLeaveRequest" runat="server" AllowSorting="True" AllowPaging="True"
                        ...
                        <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="PermDate,PermEndDate,PermissionId,AttachedFile,IsForPeriod,PermTypeId,FK_EmployeeId,FromTime,ToTime,TotalTime,IsFullDay,Days,IsFlexible,Remark">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="IsFlexible" Visible="False"
                                    UniqueName="IsFlexible" meta:resourcekey="GridBoundColumnResource14" />
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="FlexibilePermissionDuration"
                                    Visible="False" UniqueName="FlexibilePermissionDuration" meta:resourcekey="GridBoundColumnResource17" />
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="AttachedFile" Visible="False"
                                    meta:resourcekey="GridBoundColumnResource18" UniqueName="AttachedFile" />
                                ...
                                <telerik:GridTemplateColumn HeaderText="Remaining Balance" AllowFiltering="False"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblRemainingBalance" runat="server" meta:resourcekey="lblRemainingBalanceResource1" />

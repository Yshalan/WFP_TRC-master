<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GM_StudyPermissionApproval.ascx.vb"
    Inherits="Requests_UserControls_GM_GM_StudyPermissionApproval" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:MultiView ID="mvPermissionApproval" runat="server">
            <asp:View ID="viewGMApproval" runat="server">
                <div class="table-responsive">
                    ...
                    <telerik:RadGrid ID="dgrdEmpLeaveRequest" runat="server" AllowSorting="True" AllowPaging="True"
                        ...
                        meta:resourcekey="dgrdEmpLeaveRequestResource1">
                        <GroupingSettings CaseSensitive="False" />
                        <ClientSettings EnablePostBackOnRowClick="false" EnableRowHoverStyle="True">
                            <Selecting AllowRowSelect="false" />
                        </ClientSettings>
                        <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="PermDate,PermEndDate,PermissionRequestId,AttachedFile,IsForPeriod,FK_EmployeeId,IsFullDay,FromTime,ToTime,Days,
                            Remark,DaysName,DaysArabicName,StudyYear,Semester,FK_UniversityId,Emp_GPAType,Emp_GPA,FK_MajorId,FK_SpecializationId">

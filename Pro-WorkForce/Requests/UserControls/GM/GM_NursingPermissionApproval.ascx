<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GM_NursingPermissionApproval.ascx.vb"
    Inherits="Requests_UserControls_GM_GM_NursingPermissionApproval" %>
            ...
            <asp:View ID="viewDMApproval" runat="server">
                <div class="table-responsive">
                    ...
                    <telerik:RadGrid ID="dgrdEmpLeaveRequest" runat="server" AllowSorting="True" AllowPaging="True"
                        ...
                        <MasterTableView AllowMultiColumnSorting="false" CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="PermDate,PermEndDate,PermissionRequestId,AttachedFile,IsForPeriod,FK_EmployeeId,IsFlexible,FlexibilePermissionDuration,IsFullDay,AllowedTime">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="AttachedFile" Visible="False"
                                    UniqueName="AttachedFile" meta:resourcekey="GridBoundColumnResource15" />

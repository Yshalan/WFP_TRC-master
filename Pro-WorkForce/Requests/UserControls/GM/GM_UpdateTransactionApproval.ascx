<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GM_UpdateTransactionApproval.ascx.vb" Inherits="Requests_UserControls_GM_GM_UpdateTransactionApproval" %>
    ...
    <ContentTemplate>
        ...
        <div class="table-responsive">
            ...
            <telerik:RadGrid ID="dgrdUpdateTransactionRequest" runat="server" AllowSorting="True" AllowPaging="True"
                ...
                AllowMultiRowSelection="True" ShowFooter="True" CellSpacing="0" meta:resourcekey="dgrdManualEntryRequestResource1">
                ...
                <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Remarks" HeaderText="Remarks" UniqueName="Remarks" FilterControlAltText="Filter Remarks column" meta:resourcekey="GridBoundColumnResource10" />
                        <telerik:GridBoundColumn DataField="StatusName" HeaderText="Status" UniqueName="StatusName" FilterControlAltText="Filter StatusName column" meta:resourcekey="GridBoundColumnResource11" />

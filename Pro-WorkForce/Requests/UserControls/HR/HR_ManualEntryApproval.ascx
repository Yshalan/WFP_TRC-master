<%@ Control Language="VB" AutoEventWireup="false" CodeFile="HR_ManualEntryApproval.ascx.vb"
    Inherits="Requests_UserControls_HR_HR_ManualEntryApproval" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div class="table-responsive">
            ...
            <telerik:RadGrid ID="dgrdManualEntryRequest" runat="server"
                ...
                <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="MoveRequestId,AttachedFile,MoveDate,MoveTime,FK_EmployeeId,Remarks">
                    <CommandItemSettings ExportToPdfText="Export to Pdf" />
                    <Columns>
                        <telerik:GridTemplateColumn AllowFiltering="False"
                            UniqueName="TemplateColumn">
                            <HeaderTemplate>
                                <asp:CheckBox ID="checkAll" runat="server" onclick="CheckAllMoves(this)" Text="&nbsp;" Visible="true" />
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <telerik:GridBoundColumn DataField="MoveDate" DataFormatString="{0:dd/MM/yyyy}"
                            HeaderText="Date" UniqueName="MoveDate" meta:resourcekey="GridBoundColumnResource3" />
                        <telerik:GridBoundColumn DataField="MoveTime" HeaderText="Time"
                            UniqueName="MoveTime" DataFormatString="{0:HH:mm}" meta:resourcekey="GridBoundColumnResource4" />
                        <telerik:GridBoundColumn DataField="ReasonName" HeaderText="Reason"
                            UniqueName="ReasonName" meta:resourcekey="GridBoundColumnResource5" />
                        ...
                        <telerik:GridBoundColumn AllowFiltering="False" DataField="AttachedFile"
                            Visible="False"
                            UniqueName="AttachedFile" meta:resourcekey="GridBoundColumnResource9" />
                        <telerik:GridTemplateColumn HeaderText="Attached File" AllowFiltering="False"
                            UniqueName="TemplateColumn" meta:resourcekey="GridTemplateColumnResource1">
                            <ItemTemplate>
        ...
        <cc1:ModalPopupExtender ID="mpeRejectPopupManual" runat="server" BehaviorID="modelPopupExtenderManual"
            TargetControlID="hdnWindow" PopupControlID="divRejectedManual"
            DropShadow="True" OnCancelScript="ResetPopUpManual(); return false;"

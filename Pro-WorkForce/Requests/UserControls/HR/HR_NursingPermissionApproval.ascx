<%@ Control Language="VB" AutoEventWireup="false" CodeFile="HR_NursingPermissionApproval.ascx.vb"
    Inherits="Requests_UserControls_HR_HR_NursingPermissionApproval" %>
            ...
            <asp:View ID="viewDMApproval" runat="server">
                <div class="table-responsive">
                    ...
                    <telerik:RadGrid ID="dgrdEmpLeaveRequest" runat="server" AllowSorting="True" AllowPaging="True"
                        ...
                        <MasterTableView AllowMultiColumnSorting="false" CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="PermDate,PermEndDate,PermissionRequestId,AttachedFile,IsForPeriod,FK_EmployeeId,IsFlexible,FlexibilePermissionDuration,IsFullDay,AllowedTime,Remark,PermissionOption,Days">

...
Partial Class Requests_UserControls_HR_HR_UpdateTransactionApproval
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            lblManualEntryRequests.Text = ResourceManager.GetString("HRUpdateTransactionHeader", CultureInfo)
            Page.Title = "Work Force Pro : :" + ResourceManager.GetString("HRUpdateTransactionHeader", CultureInfo)
    ...
    Protected Sub lnkAccept_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If (objAPP_Settings.LeaveApproval = 2 Or objAPP_Settings.LeaveApproval = 3) Then
            ...
            Dim MoveId As String = DirectCast(DirectCast(sender, LinkButton).Parent.Parent, GridDataItem).GetDataKeyValue("MoveId")
    ...
    Protected Sub dgrdUpdateTransactionRequest_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdUpdateTransactionRequest.NeedDataSource
        ...
        objEmp_MoveUpdateRequest.Status = RequestStatus.ApprovedByDM
        dtCurrent = objEmp_MoveUpdateRequest.GetByHR()
...
#Region "Methods"
    ...
    Public Sub FillGridView()
        Try
            ...
            objEmp_MoveUpdateRequest = New Emp_MoveUpdateRequest
            objEmp_MoveUpdateRequest.FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
            dtManualRequet = objEmp_MoveUpdateRequest.GetByHR()
            dgrdUpdateTransactionRequest.DataSource = dtManualRequet
...
#Region "Proceed All"
    ...
    Private Sub AcceptAll(ByVal item As GridDataItem, ByRef ErrNo As Integer, ByRef Msg As String)
        ...
        If (objAPP_Settings.LeaveApproval = 2 Or objAPP_Settings.LeaveApproval = 3) Then
            ...
            Dim Remarks As String = String.Empty
            Dim UpdateTransactionType As String = item.GetDataKeyValue("UpdateTransactionType")

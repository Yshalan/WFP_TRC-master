<%@ Control Language="VB" AutoEventWireup="false" CodeFile="HR_PermissionApproval.ascx.vb"
    Inherits="Requests_UserControls_HR_HR_PermissionApproval" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<script type="text/javascript" language="javascript">
    function ShowPopUpPermission(Mode) {
        var lang = '<%= MsgLang %>';
        if (Mode == 1) {
            if (lang == 'en') {
            ...
            <asp:View ID="viewDMApproval" runat="server">
                <div class="table-responsive">
                    ...
                    <telerik:RadGrid ID="dgrdEmpLeaveRequest" runat="server" AllowSorting="True" AllowPaging="True"
                        ...
                        <MasterTableView AllowMultiColumnSorting="True" AutoGenerateColumns="False" CommandItemDisplay="Top" DataKeyNames="PermDate,PermEndDate,PermissionId,AttachedFile,IsForPeriod,PermTypeId,FK_EmployeeId,FromTime,ToTime,IsFullDay,IsFlexible,FlexibilePermissionDuration,TotalTime,Remark,PermissionOption,Days">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="PermName" HeaderText="Permission Type"
                                    meta:resourcekey="GridBound2ColumnResource1" UniqueName="PermName" />
                                ...
                                <telerik:GridBoundColumn DataField="PermEndDate" DataFormatString="{0:dd/MM/yyyy}"
                                    HeaderText="End Date" meta:resourcekey="GridBoundColumnResource4"
                                ...
                                <telerik:GridBoundColumn DataField="IsFlexible" HeaderText="Flexible"
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="FK_EmployeeId"
                                    Visible="False" meta:resourcekey="GridBoundColumnResource8"
                                    UniqueName="FK_EmployeeId" />
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="PermTypeId"
                                    Visible="False" meta:resourcekey="GridBoundColumnResource9"
                                    UniqueName="PermTypeId" />
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="Remarks"
                                    Visible="False" meta:resourcekey="GridBoundColumnResource10"
                                    UniqueName="Remarks" />
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="Days"
                                ...
                                <telerik:GridBoundColumn DataField="StatusName" HeaderText="Status"
                                    meta:resourcekey="GridBoundColumnResource11" UniqueName="StatusName" />
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="IsFlexible" Visible="False"
                                    UniqueName="IsFlexible" meta:resourcekey="GridBoundColumnResource17" />
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="IsFullDay" Visible="False"
                                    UniqueName="IsFullDay" meta:resourcekey="GridBoundColumnResource18" />
                                ...
                                <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="TemplateColumn"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkAccept" runat="server" Text="Accept" OnClick="lnkAccept_Click"
                                            OnClientClick="return ShowPopUpPermission('1')" meta:resourcekey="lnkAcceptResource1"></asp:LinkButton>
                ...
                <cc1:ModalPopupExtender ID="mpeRejectPopupPermission" runat="server" BehaviorID="modelPopupExtenderPermission"
                    TargetControlID="hdnWindow" PopupControlID="divRejectedPermission" DropShadow="True" OnCancelScript="ResetPopUpPermission(); return false;"

...
Partial Class Requests_UserControls_DM_DM_NursingPermissionApproval
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                MsgLang = "en"
            End If
            lblNursingPermissionRequests.Text = ResourceManager.GetString("DirectMgrNurPermitHeader", CultureInfo)
            Page.Title = "Work Force Pro : :" + ResourceManager.GetString("DirectMgrNurPermitHeader", CultureInfo)
            ShowHideControls()
            FillGridView()
        End If
    End Sub
    ...
    Protected Sub lnkAccept_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        With objAPP_Settings
            .GetByPK()
            If (.NursingPermissionApproval = 1) Then
                ...
                Dim PermissionId As Integer = CInt(DirectCast(DirectCast(sender, LinkButton).Parent.Parent, GridDataItem).GetDataKeyValue("PermissionRequestId").ToString())
                ...
                Dim AllowedTime As Integer = CInt(DirectCast(DirectCast(sender, LinkButton).Parent.Parent, GridDataItem).GetDataKeyValue("AllowedTime").ToString())
                ...
                Else
                    IsFlexible = Nothing
                End If
                Dim FlexibilePermissionDuration As Integer = CInt(DirectCast(DirectCast(sender, LinkButton).Parent.Parent, GridDataItem).GetDataKeyValue("FlexibilePermissionDuration").ToString())
                ...
                With objEmp_Nursing_Permission
                    .FK_StatusId = RequestStatus.ApprovedByDM
            ...
            ElseIf (.NursingPermissionApproval = 3 Or .NursingPermissionApproval = 4) Then
                With objEmp_Nursing_Permission
                    .FK_StatusId = RequestStatus.ApprovedByDM
                    .PermissionRequestId = CStr(DirectCast(DirectCast(sender, LinkButton).Parent.Parent, GridDataItem).GetDataKeyValue("PermissionRequestId").ToString())
                    .FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
                    .LAST_UPDATE_BY = SessionVariables.LoginUser.ID
                    Err = .UpdatePermissionStatus()
                    strMessage = ResourceManager.GetString("UpdatedSuccessfully", CultureInfo)
    ...
    Protected Sub dgrdEmpNursingRequest_OnItemCommand(ByVal sender As Object, ByVal e As GridCommandEventArgs) Handles dgrdEmpNursingRequest.ItemCommand
    ...
    Protected Sub dgrdEmpNursingRequest_ItemDataBound(ByVal sender As Object, ByVal e As GridItemEventArgs) Handles dgrdEmpNursingRequest.ItemDataBound
    ...
    Protected Sub dgrdEmpHR_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdEmpNursingRequest.NeedDataSource
        ...
        objEmp_Nursing_Permission.FK_StatusId = RequestStatus.Pending
        dtCurrent = objEmp_Nursing_Permission.GetByDirectManager()
        Dim dv As New DataView(dtCurrent)
        dv.Sort = SortExepression
        dgrdEmpNursingRequest.DataSource = dv
...
#Region "Methods"
    ...
    Public Sub FillGridView()
        Try
            ...
            objEmp_Nursing_Permission.FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
            objEmp_Nursing_Permission.FK_StatusId = RequestStatus.Pending
            dtPermissionRequest = objEmp_Nursing_Permission.GetByDirectManager()
            dgrdEmpNursingRequest.DataSource = dtPermissionRequest
            dgrdEmpNursingRequest.DataBind()
...
#Region "Grid Filter"
    ...
    Protected Function GetFilterIcon() As String
        Return RadAjaxLoadingPanel.GetWebResourceUrl(Page, String.Format("Telerik.Web.UI.Skins.{0}.Grid.Filter.gif", dgrdEmpNursingRequest.Skin))
    End Function
...
#Region "Proceed All"
    ...
    Protected Sub btnProceed_Click(sender As Object, e As System.EventArgs) Handles btnProceed.Click
        ...
        For Each item As GridDataItem In dgrdEmpNursingRequest.Items
        ...
        If Count > 0 Then
            ...
            If ErrNo = 0 Then
                ...
                CtlCommon.ShowMessage(Me.Page, Msg)
            ElseIf ErrNo = 1 Then
    ...
    Private Sub AcceptAll(ByVal item As GridDataItem, ByRef ErrNo As Integer, ByRef Msg As String)
        ...
        With objAPP_Settings
            ...
            If (.NursingPermissionApproval = 1) Then
                ...
                Dim PermissionId As Integer = CInt(item.GetDataKeyValue("PermissionRequestId").ToString())
                ...
                Dim AttachedFile As String = item.GetDataKeyValue("AttachedFile").ToString()
                Dim Remarks As String = String.Empty
                Dim AllowedTime As Integer = CInt(item.GetDataKeyValue("AllowedTime").ToString())
                Dim IsFlexible As Boolean
                ...
                Else
                    IsFlexible = Nothing
                End If
                Dim FlexibilePermissionDuration As Integer = CInt(item.GetDataKeyValue("FlexibilePermissionDuration").ToString())
                ...
                With objEmp_Nursing_Permission
                    ...
                    .FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
                    .LAST_UPDATE_BY = SessionVariables.LoginUser.ID
                    .PermissionRequestId = CInt(item.GetDataKeyValue("PermissionRequestId").ToString())
                    Err = .UpdatePermissionStatus()
                    strMessage = ResourceManager.GetString("UpdatedSuccessfully", CultureInfo)
            ...
            ElseIf (.NursingPermissionApproval = 3 Or .NursingPermissionApproval = 4) Then
                With objEmp_Nursing_Permission
                    .FK_StatusId = RequestStatus.ApprovedByDM
                    .PermissionRequestId = CStr(item.GetDataKeyValue("PermissionRequestId").ToString())
                    .FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
                    .LAST_UPDATE_BY = SessionVariables.LoginUser.ID
                    Err = .UpdatePermissionStatus()
                    strMessage = ResourceManager.GetString("UpdatedSuccessfully", CultureInfo)

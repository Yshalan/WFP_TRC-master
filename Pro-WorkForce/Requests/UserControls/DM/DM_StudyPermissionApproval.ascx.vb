...
Partial Class Requests_UserControls_DM_StudyPermissionApproval
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                MsgLang = "en"
            End If
            lblStudyPermissionRequests.Text = ResourceManager.GetString("DirectMgrStudyPermitHeader", CultureInfo)
            Page.Title = "Work Force Pro : :" + ResourceManager.GetString("DirectMgrStudyPermitHeader", CultureInfo)
            ShowHideControls()
            FillGridView()
        End If
    End Sub
    ...
    Protected Sub lnkAccept_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        With objAPP_Settings
            .GetByPK()
            If (.StudyPermissionApproval = 1) Then
                ...
                Dim FlexibilePermissionDuration As Integer
                ...
                'Else
                objEmp_Permissions.AddPermAllProcess(EmployeeId, -1, False, False, True, Remarks, FromDate,
                                                     ToDate, Not IsForPeriod, FromTime, ToTime, PermDate, PermissionDaysCount, OffAndHolidayDays, days,
                                                     EmpLeaveTotalBalance, PermissionId, 3, FlexibilePermissionDuration, AttachedFile, IsFullyDay, Nothing, ErrorMessage, StudyYear, Semester,
                ...
                With objEmp_Study_PermissionRequest
                    ...
                    End If
                End With
            ElseIf (.StudyPermissionApproval = 3 Or .StudyPermissionApproval = 4) Then
                With objEmp_Study_PermissionRequest
                    .FK_StatusId = RequestStatus.ApprovedByDM
    ...
    Protected Sub dgrdEmpStudyPermRequest_OnItemCommand(ByVal sender As Object, ByVal e As GridCommandEventArgs) Handles dgrdEmpStudyPermRequest.ItemCommand
    ...
    Protected Sub dgrdEmpStudyPermRequest_ItemDataBound(ByVal sender As Object, ByVal e As GridItemEventArgs) Handles dgrdEmpStudyPermRequest.ItemDataBound
    ...
    Protected Sub dgrdEmpHR_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdEmpStudyPermRequest.NeedDataSource
        ...
        dtCurrent = objEmp_Study_PermissionRequest.GetByDirectManager()
        Dim dv As New DataView(dtCurrent)
        dv.Sort = SortExepression
        dgrdEmpStudyPermRequest.DataSource = dv
...
#Region "Methods"
    ...
    Public Sub FillGridView()
        Try
            ...
            objEmp_Study_PermissionRequest.FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
            objEmp_Study_PermissionRequest.FK_StatusId = RequestStatus.Pending
            dtPermissionRequest = objEmp_Study_PermissionRequest.GetByDirectManager()
            dgrdEmpStudyPermRequest.DataSource = dtPermissionRequest
            dgrdEmpStudyPermRequest.DataBind()
...
#Region "Grid Filter"
    ...
    Protected Function GetFilterIcon() As String
        Return RadAjaxLoadingPanel.GetWebResourceUrl(Page, String.Format("Telerik.Web.UI.Skins.{0}.Grid.Filter.gif", dgrdEmpStudyPermRequest.Skin))
    End Function
...
#Region "Proceed All"
    ...
    Protected Sub btnProceed_Click(sender As Object, e As System.EventArgs) Handles btnProceed.Click
        ...
        For Each item As GridDataItem In dgrdEmpStudyPermRequest.Items
    ...
    Private Sub AcceptAll(ByVal item As GridDataItem, ByRef ErrNo As Integer, ByRef Msg As String)
        ...
        With objAPP_Settings
            ...
            If (.StudyPermissionApproval = 1) Then
                ...
                'Else
                objEmp_Permissions.AddPermAllProcess(EmployeeId, -1, False, False, False, Remarks, FromDate,
                                                     ToDate, Not IsForPeriod, FromTime, ToTime, PermDate, PermissionDaysCount, OffAndHolidayDays, days,
                                                     EmpLeaveTotalBalance, PermissionId, 3, 0, AttachedFile, IsFullyDay, Nothing, ErrorMessage, StudyYear, Semester,
                                                     FK_UniversityId, Emp_GPAType, Emp_GPA, FK_MajorId, FK_SpecializationId)
                ' End If

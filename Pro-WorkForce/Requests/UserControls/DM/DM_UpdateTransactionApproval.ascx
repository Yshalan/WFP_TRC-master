<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DM_UpdateTransactionApproval.ascx.vb"
    Inherits="Requests_UserControls_DM_DM_UpdateTransactionApproval" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div class="table-responsive">
            ...
            <telerik:RadGrid ID="dgrdUpdateTransactionRequest" runat="server" AllowSorting="True" AllowPaging="True"
                GridLines="None" ShowStatusBar="True" AllowMultiRowSelection="True" ShowFooter="True" CellSpacing="0" meta:resourcekey="dgrdUpdateTransactionRequestResource1">
                <GroupingSettings CaseSensitive="False" />
                <ClientSettings EnableRowHoverStyle="True">
                    <Selecting AllowRowSelect="True" />
                </ClientSettings>
                <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False"
                    DataKeyNames="MoveRequestId,AttachedFile,MoveDate,MoveTime,FK_EmployeeId,NextApprovalStatus,Remarks,MoveId,UpdateTransactionType">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn AllowFiltering="False"
                            ...
                            <HeaderTemplate>
                                <asp:CheckBox ID="checkAll" runat="server" onclick="CheckUpdateAll(this)" Text="&nbsp;" meta:resourcekey="checkAllResource1" />
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:CheckBox ID="chk" runat="server" Text="&nbsp;" meta:resourcekey="chkResource1" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridBoundColumn DataField="EmployeeNo" HeaderText="Emp No" UniqueName="EmployeeNo" FilterControlAltText="Filter EmployeeNo column" meta:resourcekey="GridBoundColumnResource1" />
                        <telerik:GridBoundColumn DataField="EmployeeName" HeaderText="Employee Name" UniqueName="EmployeeName" FilterControlAltText="Filter EmployeeName column" meta:resourcekey="GridBoundColumnResource2" />
                        <telerik:GridBoundColumn DataField="MoveDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Date"
                            UniqueName="MoveDate" FilterControlAltText="Filter MoveDate column" meta:resourcekey="GridBoundColumnResource3" />
                        <telerik:GridBoundColumn DataField="MoveTime" HeaderText="Time" UniqueName="MoveTime"
                            DataFormatString="{0:HH:mm}" FilterControlAltText="Filter MoveTime column" meta:resourcekey="GridBoundColumnResource4" />
                        <telerik:GridBoundColumn DataField="ReasonName" HeaderText="Reason" UniqueName="ReasonName" FilterControlAltText="Filter ReasonName column" meta:resourcekey="GridBoundColumnResource5" />
                        ...
                        <telerik:GridBoundColumn AllowFiltering="False" DataField="NextApprovalStatus" Visible="False"
                            UniqueName="NextApprovalStatus" FilterControlAltText="Filter NextApprovalStatus column" meta:resourcekey="GridBoundColumnResource10" />
                        <telerik:GridBoundColumn AllowFiltering="False" DataField="UpdateTransactionType" Visible="False"
                            UniqueName="UpdateTransactionType" FilterControlAltText="Filter UpdateTransactionType column" meta:resourcekey="GridBoundColumnResource11" />
                        <telerik:GridTemplateColumn HeaderText="Attached File" AllowFiltering="False" UniqueName="TemplateColumn" FilterControlAltText="Filter TemplateColumn column" meta:resourcekey="GridTemplateColumnResource2">
                            <ItemTemplate>
                        ...
                        <telerik:GridBoundColumn DataField="Remarks" HeaderText="Remarks" UniqueName="Remarks" FilterControlAltText="Filter Remarks column" meta:resourcekey="GridBoundColumnResource12" />
                        <telerik:GridBoundColumn DataField="StatusName" HeaderText="Status" UniqueName="StatusName" FilterControlAltText="Filter StatusName column" meta:resourcekey="GridBoundColumnResource13" />
        ...
        <cc1:ModalPopupExtender ID="mpeRejectPopupUpdate" runat="server" BehaviorID="modelPopupExtenderUpdate"
            TargetControlID="hdnWindow" PopupControlID="divRejectedupdate" DropShadow="True" OnCancelScript="ResetPopUpUpdate(); return false;"

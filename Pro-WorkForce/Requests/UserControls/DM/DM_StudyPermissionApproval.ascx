<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DM_StudyPermissionApproval.ascx.vb"
    Inherits="Requests_UserControls_DM_StudyPermissionApproval" %>
...
<script type="text/javascript" language="javascript">
    ...
    function CheckAllStudy(id) {
        var masterTable = $find("<%= dgrdEmpStudyPermRequest.ClientID%>").get_masterTableView();
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div class="row">
            <div class="col-md-4">
                <asp:Label ID="lblStudyPermissionRequests" runat="server" Text="Study Permission Requests"
                    CssClass="Profiletitletxt" meta:resourcekey="lblPermissionRequestsResource1" />
        ...
        <div class="row" runat="server" id="divRejectAllReason" visible="false">
            ...
            <div class="col-md-4">
                <asp:TextBox ID="txtRejectAllReason" runat="server" ToolTip="Rejection Reason" TextMode="MultiLine"
                    placeholder="Rejection Reason" meta:resourcekey="txtRejectAllReasonResource1"></asp:TextBox>
            </div>
        </div>
        ...
        <asp:MultiView ID="mvPermissionApproval" runat="server">
            <asp:View ID="viewDMApproval" runat="server">
                <div class="table-responsive">
                    <telerik:RadFilter runat="server" ID="RadFilter1" FilterContainerID="dgrdEmpStudyPermRequest"
                        Skin="Hay" ShowApplyButton="False" meta:resourcekey="RadFilter1Resource1" />
                    <telerik:RadGrid ID="dgrdEmpStudyPermRequest" runat="server" AllowSorting="True" AllowPaging="True"
                        GridLines="None" ShowStatusBar="True" AllowMultiRowSelection="True" PageSize="10"
                        ShowFooter="True" meta:resourcekey="dgrdEmpStudyPermRequestResource1">
                        ...
                        <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False"
                            DataKeyNames="PermDate,PermEndDate,PermissionRequestId,AttachedFile,IsForPeriod,FK_EmployeeId,IsFlexible,FlexibilePermissionDuration,FromTime,ToTime,IsFullDay,Days,Remark,DaysName,DaysArabicName,
                            StudyYear,Semester,FK_UniversityId,Emp_GPAType,Emp_GPA,FK_MajorId,FK_SpecializationId">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="Remarks" Visible="False"
                                    UniqueName="Remarks" meta:resourcekey="GridBoundColumnResource10" />
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="PermissionOption" Visible="False"
                                    UniqueName="PermissionOption" meta:resourcekey="GridBoundColumnResource13" />
                                ...
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="FlexibilePermissionDuration"
                                    Visible="False" UniqueName="FlexibilePermissionDuration" meta:resourcekey="GridBoundColumnResource16" />
                                <telerik:GridBoundColumn AllowFiltering="False" DataField="AttachedFile" Visible="False"
                                    meta:resourcekey="GridBoundColumnResource17" UniqueName="AttachedFile" />
                                ...
                                <telerik:GridBoundColumn DataField="Remark" HeaderText="Remarks" UniqueName="Remark"
                                    meta:resourcekey="GridBoundColumnResource18" />
                ...
                <cc1:ModalPopupExtender ID="mpeRejectPopupStudy" runat="server" BehaviorID="modelPopupExtenderStudy"
                    TargetControlID="hdnWindow" PopupControlID="divRejectedStudy" DropShadow="True"
                    OnCancelScript="ResetPopUpStudy(); return false;" CancelControlID="btnCancel"
                    Enabled="True" BackgroundCssClass="ModalBackground" DynamicServicePath="" />
            </asp:View>
        </asp:MultiView>

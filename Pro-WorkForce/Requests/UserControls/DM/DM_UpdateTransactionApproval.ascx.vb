...
Partial Class Requests_UserControls_DM_DM_UpdateTransactionApproval
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            lblManualEntryRequests.Text = ResourceManager.GetString("DirectMgrUpdateTransactionHeader", CultureInfo)
            Page.Title = "Work Force Pro : :" + ResourceManager.GetString("DirectMgrUpdateTransactionHeader", CultureInfo)
    ...
    Protected Sub lnkAccept_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ElseIf (objAPP_Settings.LeaveApproval = 3 Or objAPP_Settings.LeaveApproval = 4) Then
            With objEmp_MoveUpdateRequest
                .Status = NextApprovalStatus
                .MoveRequestId = CInt(DirectCast(DirectCast(sender, LinkButton).Parent.Parent, GridDataItem).GetDataKeyValue("MoveRequestId").ToString())
                .LAST_UPDATE_BY = SessionVariables.LoginUser.ID
    ...
    Protected Sub dgrdUpdateTransactionRequest_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdUpdateTransactionRequest.NeedDataSource
        ...
        objEmp_MoveUpdateRequest.Status = RequestStatus.Pending
        dtCurrent = objEmp_MoveUpdateRequest.GetByDirectManager()
...
#Region "Methods"
    ...
    Public Sub FillGridView()
        Try
            ...
            objEmp_MoveUpdateRequest.FK_ManagerId = SessionVariables.LoginUser.FK_EmployeeId
            objEmp_MoveUpdateRequest.Status = RequestStatus.Pending
            dtManualEntryRequets = objEmp_MoveUpdateRequest.GetByDirectManager()
...
#Region "Proceed All"
    ...
    Private Sub AcceptAll(ByVal item As GridDataItem, ByRef ErrNo As Integer, ByRef Msg As String)
        ...
        End If
        If (objAPP_Settings.LeaveApproval = 1) Then

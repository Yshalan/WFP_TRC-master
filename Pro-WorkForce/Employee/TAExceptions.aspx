<%@ Page Title="" Language="VB" Theme="SvTheme"  MasterPageFile="~/Default/NewMaster.master" AutoEventWireup="false"
    CodeFile="TAExceptions.aspx.vb" Inherits="Employee_TAExceptions" meta:resourcekey="PageResource1"
    UICulture="auto" %>
            ...
            <div class="row">
                ...
                <asp:Panel ID="pnlEndDate" runat="server" Visible="False" meta:resourcekey="pnlEndDateResource1">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:RequiredFieldValidator ID="rfvToDate" runat="server" ControlToValidate="dtpFromdate"
                        ...
                        <asp:CompareValidator ID="CVDate" runat="server" ControlToCompare="dtpFromdate"
                            ControlToValidate="dtpEndDate" ErrorMessage="To Date should be greater than or equal to From Date"
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                            ...
                            <asp:Button ID="btnDelete" OnClientClick="return ValidateDelete();" runat="server" Text="Delete"  CssClass="button"
                ...
                <div class="row">
                    <div class="table-responsive">
                        ...
                        <telerik:RadGrid runat="server" ID="dgrdTAExceptions" AllowSorting="True" AllowPaging="True"
                            ...
                            ShowFooter="True" meta:resourcekey="dgrdTAExceptionsResource1">
                            ...
                            <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="FK_EmployeeId,FromDate,ToDate">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="ToDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="To Date"
                                        UniqueName="ToDate" meta:resourcekey="GridBoundColumnResource7" />
                                </Columns>
                                <CommandItemTemplate>

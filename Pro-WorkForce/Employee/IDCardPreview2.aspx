<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IDCardPreview2.aspx.vb" Inherits="Employee_IDCardPreview2" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" rightMargin="0" topMargin="0" onload="ChkSmartID()">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" border="0" cellSpacing="0" cellPadding="0" width="100%" align="center"
				height="100%">
				<TR>
					<TD align="center" id="Print1" valign="middle">

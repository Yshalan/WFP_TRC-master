...
Partial Class Employee_ViolationException
...
#Region "Class Variables"
    ...
    Dim objEmp_ViolationException As New Emp_ViolationException
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ElseIf SessionVariables.CultureInfo = "ar-JO" Then
                Lang = CtlCommon.Lang.AR
                PageHeader1.HeaderText = ResourceManager.GetString("ViolationExceptions", CultureInfo)
            Else
                Lang = CtlCommon.Lang.EN
                PageHeader1.HeaderText = ResourceManager.GetString("ViolationExceptions", CultureInfo)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        ...
        objEmp_ViolationException = New Emp_ViolationException
        Dim errornum As Integer
        With objEmp_ViolationException
    ...
    Protected Sub dgrdTAExceptions_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdTAExceptions.NeedDataSource
        ...
        objEmp_ViolationException = New Emp_ViolationException()
        dtCurrent = objEmp_ViolationException.GetAllInnerEmployee()

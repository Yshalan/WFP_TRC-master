...
Partial Class Employee_TAExceptions
...
#Region "Class Variables"
    ...
    Dim objEmp_TAExceptions As New Emp_TAExceptions
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ElseIf SessionVariables.CultureInfo = "ar-JO" Then
                Lang = CtlCommon.Lang.AR
                PageHeader1.HeaderText = ResourceManager.GetString("TAException", CultureInfo)
            Else
                Lang = CtlCommon.Lang.EN
                PageHeader1.HeaderText = ResourceManager.GetString("TAException", CultureInfo)
    ...
    Protected Sub dgrdTAExceptions_NeedDataSource(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles dgrdTAExceptions.NeedDataSource
        ...
        objEmp_TAExceptions = New Emp_TAExceptions()
        dtCurrent = objEmp_TAExceptions.GetAllInnerEmployee()

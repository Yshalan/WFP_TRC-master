...
Partial Class Emp_userControls_EmpPermissions2
...
#Region "Class Variables"
    ...
    Private objEmpPermissionsRequest As Emp_PermissionsRequest
...
#Region "Methods & Events"
    ...
    Private Sub FillControls()
        ...
        objEmpPermissions = New Emp_Permissions()
        objEmpPermissionsRequest = New Emp_PermissionsRequest()
        objEmpPermissions.PermissionId = PermissionId
        objEmpPermissionsRequest.PermissionId = PermissionId
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, _
        ...
        For Each row As GridDataItem In dgrdVwEmpPermissions.Items
            ...
            If cb.Checked Then
                ...
                Dim intPermissionId As Integer = _
                ...
                objEmpPermissionsRequest.PermissionId = intPermissionId
                If IsRequest = 0 Then
                    objEmpPermissions.GetByPK()
                End If

                If Not objEmpPermissions.Days = "&nbsp;" Then
                    intPermDays = objEmpPermissions.Days
                End If
                If IsRequest = 0 Then
                    errNum = objEmpPermissions.Delete()
                Else
                    errNum = objEmpPermissionsRequest.Delete()
                End If
...
#Region "GridView Paging and sorting"
    ...
    '    End Try
    'End Sub
    Protected Sub dgrdVwEmpPermissions_DataBound(ByVal sender As Object, _
...
#Region "Display Mode Functions"
    ...
    Function saveUpdate() As Integer
        ...
        If PermissionType = PermissionOption.Normal Then
            If rdlTimeOption.SelectedValue = 0 Then
                If (objEmpPermissions.ValidateEmployeePermission(EmployeeFilterUC.EmployeeId, PermissionId, dtCurrent, radBtnOneDay.Checked, dtpStartDatePerm.SelectedDate, dtpEndDatePerm.SelectedDate, tpFromTime, _
            ...
            ElseIf rdlTimeOption.SelectedValue = 1 Then
                ...
                If (objEmpPermissions.ValidateEmployeeFlexiblePermission(EmployeeFilterUC.EmployeeId, PermissionId, dtCurrent, radBtnOneDay.Checked, _
        ...
        objEmpPermissions.AddPermAllProcess(EmployeeFilterUC.EmployeeId, RadCmpPermissions.SelectedValue, chckIsDividable.Checked, isFlixible, radBtnSpecificDays.Checked, _
                                         ...
                                         Integer.Parse(PermissionType), Integer.Parse(strFlexibileDuration), fileUploadExtension, chckFullDay.Checked, AllowedTime, _
                                         ErrorMessage, StudyYear, txtSemester.Text)
    ...
    Function updateOnly() As Integer
        ...
        objEmpPermissions.FillObjectData(EmployeeFilterUC.EmployeeId, RadCmpPermissions.SelectedValue, chckIsDividable.Checked, isFlixible, radBtnSpecificDays.Checked, _
                                 txtRemarks.Text, dtpStartDatePerm.SelectedDate, dtpEndDatePerm.SelectedDate, radBtnOneDay.Checked, tpFromTime, _

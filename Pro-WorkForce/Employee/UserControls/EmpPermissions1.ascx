<%@ Control Language="VB" AutoEventWireup="false" CodeFile="EmpPermissions1.ascx.vb"
    Inherits="Emp_userControls_EmpPermissions1" %>
    ...
    <ContentTemplate>
        ...
        <div class="row" id="trType" runat="server">
            ...
            <div class="col-md-8" id="tdOption" runat="server">
                <%--<asp:RadioButtonList ID="rdlPermissionOption" runat="server" AutoPostBack="true">
                                                    <asp:ListItem Text="One Time Permission" Value="1" meta:resourcekey="radBtnOneDayResource1" />
                                                    <asp:ListItem Text="Permission For Period" Value="2"  meta:resourcekey="radBtnPeriodResource1" />
                                                    <asp:ListItem Text="Specific Days for Duration" Value="3" meta:resourcekey="radBtnSpecificDaysResource1" />
                                                </asp:RadioButtonList>--%>
                                        ...
                                        <div class="row">
                                            <div class="table-responsive">
                                                ...
                                                <telerik:RadGrid ID="dgrdVwEmpPermissions" runat="server" AllowPaging="True" AllowSorting="True"
                                                    ...
                                                    <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="PermissionId,FK_PermId,FK_LeaveId,FromTime,ToTime,PermDate,PermEndDate,IsFullDay,IsFlexible,FlexibilePermissionDuration,IsForPeriod">

<%@ Control Language="VB" AutoEventWireup="false" CodeFile="EmpPermissions.ascx.vb"
    Inherits="Emp_userControls_EmpPermissions" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ValidateDelete(sender, eventArgs) {
        var grid = $find("<%=dgrdVwEmpPermissions.ClientID %>");
    ...
    function limitTextRemarks(limitNum) {
        var limitCount = document.getElementById("<%=lblRemarkValidationVal.ClientID%>");
        var limitField = document.getElementById("<%=txtRemarks.ClientID%>");
...
<asp:UpdatePanel ID="updatePnlEmpPerm" runat="server">
    ...
    <ContentTemplate>
        ...
        <div class="row" id="divAllowedTime" runat="server" visible="false">
            <div class="col-md-2">
        ...
        <div class="row" id="trFullyDay" runat="server">
            ...
            <div class="col-md-4">
                <asp:CheckBox ID="chckFullDay" runat="server" AutoPostBack="true" Text="Is Full Day"
        ...
        <div class="row" id="trSpecificTime" runat="server">
            ...
            <div class="col-md-3">
                ...
                <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="RadTPtoTime"
                    Display="None" ValidationGroup="EmpPermissionGroup" meta:resourcekey="CustomValidator1Resource1" />
                <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="RadTPfromTime"
                    Display="None" ValidationGroup="EmpPermissionGroup" meta:resourcekey="CustomValidator2Resource1" />
        ...
        <br />
        <asp:Panel ID="pnlAdditionalDetails" runat="server" GroupingText="Additional Study Details" meta:resourcekey="pnlAdditionalDetailsResource1" Visible="false">
            ...
            <div class="row">
                <div class="col-md-2">
                    <asp:Label CssClass="Profiletitletxt" ID="lblStudyYear" Visible="false" runat="server"
                        Text="Year" meta:resourcekey="lblYearResource1"></asp:Label>
                </div>
                <div class="col-md-4">
                    <%-- <asp:TextBox ID="txtStudyYear" Visible="false" runat ="server"></asp:TextBox>--%>
                    <telerik:RadNumericTextBox ID="txtStudyYear" Visible="false" MinValue="0" MaxValue="99999"
                        Skin="Vista" runat="server" Culture="en-US" LabelCssClass="" Width="158px" meta:resourcekey="txtStudyYearResource1">
            ...
            <div class="row">
                <div class="col-md-2">
                    <asp:Label CssClass="Profiletitletxt" ID="lblSemester" Visible="false" runat="server"
                        Text="Semester" meta:resourcekey="lblSemesterResource1"></asp:Label>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4" id="trRemarks" runat="server">
                <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" meta:resourcekey="txtRemarksResource1"
                    onkeydown="limitTextRemarks(500);" onkeyup="limitTextRemarks(500);"></asp:TextBox>
                <asp:Label ID="lblRemarkValidation1" runat="server" Text="(Maximum characters: 500) You Have" SkinID="SVlabel_RemarkValidation" Visible="false"></asp:Label>
                <asp:Label ID="lblRemarkValidationVal" runat="server" SkinID="SVlabel_RemarkValidation" Text="500" Visible="false"></asp:Label>
                <asp:Label ID="lblRemarkValidation2" runat="server" Text="Character(s) Left" SkinID="SVlabel_RemarkValidation" Visible="false"></asp:Label>
                <asp:RegularExpressionValidator Display="Dynamic" ControlToValidate="txtRemarks"
                    ID="revRemarks" ValidationExpression="^[\s\S]{0,500}$" runat="server"
                    ErrorMessage="Maximum 500 characters allowed." ValidationGroup="EmpPermissionGroup" Enabled="false"></asp:RegularExpressionValidator>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8" colspan="2" align="center">
                ...
                <asp:Button ID="btnDelete" runat="server" OnClientClick="return ValidateDelete();"
                    Text="Delete" CssClass="button" CausesValidation="false" meta:resourcekey="btnDeleteResource1" />
            ...
            <div class="table-responsive">
                ...
                <telerik:RadGrid ID="dgrdVwEmpPermissions" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False"
                        DataKeyNames="PermissionId,FK_PermId,FK_LeaveId,FromTime,ToTime,PermDate,PermEndDate,IsFullDay,IsFlexible,FlexibilePermissionDuration,IsForPeriod,FK_EmployeeId">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn AllowFiltering="False" DataField="IsFullDay" UniqueName="IsFullDay"
                                HeaderText="Full Day" meta:resourcekey="GridBoundColumnResource16" />

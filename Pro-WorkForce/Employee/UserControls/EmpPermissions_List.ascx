<%@ Control Language="VB" AutoEventWireup="false" CodeFile="EmpPermissions_List.ascx.vb"
    Inherits="Emp_UserControls_EmpPermissions_List" %>
<%@ Register Src="../../UserControls/PageHeader.ascx" TagName="PageHeader" TagPrefix="uc1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<uc1:PageHeader ID="PageHeader1" runat="server" HeaderText="Employee Permissions" />
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="table-repsonsive">
                    <telerik:RadGrid ID="grdEmpPermissions" runat="server" AllowMultiRowSelection="True"
                        ...
                        <MasterTableView AutoGenerateColumns="False" IsFilterItemExpanded="False">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="PermDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Permission Date"
                                ...
                                <telerik:GridBoundColumn DataField="PermissionDuration" HeaderText="Permission Duration" meta:resourcekey="GridBoundColumnResource6" />

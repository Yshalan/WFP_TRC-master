<%@ Page Title="" Language="VB" Theme="SvTheme" MasterPageFile="~/Default/NewMaster.master"
    AutoEventWireup="false" CodeFile="ViolationException.aspx.vb" Inherits="Employee_ViolationException"
                    ...
                    <div class="col-md-4">
                        ...
                        <div>
                            <asp:CompareValidator ID="CVDate" runat="server" ControlToCompare="dtpFromdate" ControlToValidate="dtpEndDate"
                                ...
                                Operator="GreaterThanEqual" Type="Date" ValidationGroup="TaException" meta:resourcekey="CVDateResource1" />
                ...
                <div class="col-md-12">
                    <center>
                        <asp:Button ID="btnSave" runat="server" Text="Save" Width="110px" CssClass="button"
                            ValidationGroup="TaException" meta:resourcekey="btnAssignResource1" />
                        <asp:Button ID="btnDelete" OnClientClick="return ValidateDelete();" runat="server"
                            Text="Delete" Width="110px" CssClass="button" meta:resourcekey="btnDeleteResource1" />
                        ...
                        <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="EmployeeNo" HeaderText="Employee Number" SortExpression="EmployeeNo"
                                    UniqueName="EmployeeNo" meta:resourcekey="GridBoundColumnResource1" FilterControlAltText="Filter EmployeeNo column">
                                ...
                                <telerik:GridBoundColumn DataField="EmployeeArabicName" HeaderText="Employee Arabic Name"
                                    ...
                                    FilterControlAltText="Filter EmployeeArabicName column">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="FK_EmployeeId" DataType="System.Int32" Visible="False"
                                    ...
                                    FilterControlAltText="Filter FK_EmployeeId column">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="ToDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="To Date"
                                    UniqueName="ToDate" meta:resourcekey="GridBoundColumnResource7" FilterControlAltText="Filter ToDate column" />
                            </Columns>
                            <CommandItemTemplate>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Coordinator_LeavesRequest.aspx.vb" MasterPageFile="~/Default/NewMaster.master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function ValidateDelete(sender, eventArgs) {
            var grid = $find("<%=dgrdCoordinatorLeaveRequest.ClientID%>");
    ...
    <asp:UpdatePanel ID="Update1" runat="server">
        <ContentTemplate>
            <uc1:PageHeader ID="CoordinatorLeaveRequestHeader" runat="server" HeaderText="Coordinator Leave Request" />
            <div class="row">
                <div class="col-md-12">
                    <uc2:PageFilter ID="EmployeeFilterUC" runat="server" HeaderText="Employee Filter"
                        OneventEmployeeSelect="FillGridView" ValidationGroup="empleave" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <asp:Button ID="btnDelete" runat="server" Text="Delete Leave"
                        OnClientClick="return ValidateDelete();" CssClass="button" meta:resourcekey="btnDeleteResource1" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="table-responsive">
                <telerik:RadFilter runat="server" ID="RadFilter1" FilterContainerID="dgrdCoordinatorLeaveRequest"
                    Skin="Hay" ShowApplyButton="False" meta:resourcekey="RadFilter1Resource1" />
                <telerik:RadGrid ID="dgrdCoordinatorLeaveRequest" runat="server" AllowSorting="True" AllowPaging="True"

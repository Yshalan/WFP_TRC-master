<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Coordinator_PermissionRequest.aspx.vb"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="Update1" runat="server">
        <ContentTemplate>
            <uc1:PageHeader ID="CoordinatorPermissionRequestHeader" runat="server" HeaderText="Employee Permission Request" />
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="Svpanel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <asp:Button ID="btnDelete" runat="server" Text="Delete Leave" OnClientClick="return ValidateDelete();"

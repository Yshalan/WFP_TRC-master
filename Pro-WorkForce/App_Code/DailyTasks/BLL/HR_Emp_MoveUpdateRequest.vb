...
Namespace TA.DailyTasks
    ...
    Public Class HR_Emp_MoveUpdateRequest
...
#Region "Class Variables"
        ...
        Private objDALHR_Emp_MoveUpdateRequest As DALHR_Emp_MoveUpdateRequest
...
#Region "Public Properties"
        ...
        Public Property IsRejected() As String
            Set(ByVal value As String)
                _IsRejected = value
            End Set
            Get
...
#Region "Constructor"
        ...
        Public Sub New()
            ...
            objDALHR_Emp_MoveUpdateRequest = New DALHR_Emp_MoveUpdateRequest()
...
#Region "Methods"
        ...
        Public Function Add() As Integer
            ...
            Return objDALHR_Emp_MoveUpdateRequest.Add(_MoveRequestId, _FK_EmployeeId, _Type, _MoveDate, _MoveTime, _FK_ReasonId, _Remarks, _Reader, _M_DATE_NUM, _M_TIME_NUM, _Status, _SYS_Date, _IsManual, _CREATED_BY, _IsFromMobile, _MobileCoordinates, _IsRejected, _AttachedFile, _RejectionReason, _MoveId, _UpdateTransactionType)
            App_EventsLog.Insert_ToEventLog("Add", _MoveRequestId, "HR_Emp_MoveUpdateRequest", "Human Resource Update Transaction Request")
        End Function

        Public Function Update() As Integer

            Return objDALHR_Emp_MoveUpdateRequest.Update(_MoveRequestId, _FK_EmployeeId, _Type, _MoveDate, _MoveTime, _FK_ReasonId, _Remarks, _Reader, _M_DATE_NUM, _M_TIME_NUM, _Status, _SYS_Date, _IsManual, _LAST_UPDATE_BY, _IsFromMobile, _MobileCoordinates, _IsRejected, _AttachedFile, _RejectionReason, _MoveId, _UpdateTransactionType)
            App_EventsLog.Insert_ToEventLog("Update", _MoveRequestId, "HR_Emp_MoveUpdateRequest", "Human Resource Update Transaction Request")
        End Function

        Public Function Delete() As Integer

            Return objDALHR_Emp_MoveUpdateRequest.Delete(_MoveRequestId)
            App_EventsLog.Insert_ToEventLog("Delete", _MoveRequestId, "HR_Emp_MoveUpdateRequest", "Human Resource Update Transaction Request")
        End Function

        Public Function GetAll() As DataTable

            Return objDALHR_Emp_MoveUpdateRequest.GetAll()

        End Function

        Public Function GetByPK() As HR_Emp_MoveUpdateRequest

            Dim dr As DataRow
            dr = objDALHR_Emp_MoveUpdateRequest.GetByPK(_MoveRequestId)
        ...
        Public Function Getfilter() As DataTable
            ...
            Return objDALHR_Emp_MoveUpdateRequest.GetFilter(FK_EmployeeId, MoveDate)

        End Function

        Public Function GetAll_ByStatus() As DataTable

            Return objDALHR_Emp_MoveUpdateRequest.GetAll_ByStatus(_UserId)

        End Function

        Public Function GetAll_Rejected() As DataTable

            Return objDALHR_Emp_MoveUpdateRequest.GetAll_Rejected(_UserId)
        ...
        Public Function Update_Request_Status() As Integer
            ...
            Return objDALHR_Emp_MoveUpdateRequest.Update_Request_Status(_MoveRequestId, _IsRejected, _RejectionReason, _LAST_UPDATE_BY)

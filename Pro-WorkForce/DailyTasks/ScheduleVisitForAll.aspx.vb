...
#Region "Page Events"
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        With objVisitInfo
            ...
            .FK_DepartmentId = empfilter.EntityId
            .FK_EmployeeId = empfilter.EmployeeId
...
#Region "Methods"
    ...
    Private Sub LoadVisitDeatils()
        objVisitors = New Visitors
        objVisitors.CREATED_BY = UserId
        grdVisitDetails.DataSource = objVisitors.GetAllVisitDetails()
    ...
    Private Sub FillControls()
        objVisitors = New Visitors
        objVisitInfo = New VisitInfo
        objVisitInfo.VisitId = VisitId
        objVisitors.VisitorId = VisitorId
        objVisitInfo.GetByPK()
        objVisitors.GetByPK()

        'txtName.Text = objVisitors.VisitorName
        txtNameAr.Text = objVisitors.VisitorArabicName
        radcmbxNationality.SelectedValue = objVisitors.Nationality
        txtMobile.Text = objVisitors.MobileNumber
        txtOrganization.Text = objVisitors.OrganizationName
        ddlGender.SelectedValue = objVisitors.Gender
        txtEID.Text = objVisitors.IDNumber
        'rdDOB.SelectedDate = objVisitors.DOB
        'rdEidExpiry.SelectedDate = objVisitors.EIDExpiryDate
        dtpVisitDate.SelectedDate = objVisitInfo.ExpectedCheckInTime
        RadTPfromTime.SelectedTime = objVisitInfo.ExpectedCheckInTime.TimeOfDay
        RadTPtoTime.SelectedTime = objVisitInfo.ExpectedCheckOutTime.TimeOfDay
        ddlreason.SelectedValue = objVisitInfo.ReasonOfVisit
    End Sub
    ...
    Private Sub FillVisitDetails()
        ...
        With objVisitInfo
            ...
            empfilter.EmployeeId = .FK_EmployeeId
            empfilter.GetEmployeeInfo(.FK_EmployeeId)
        End With
    End Sub

<%@ Page Title="" Language="VB" MasterPageFile="~/Default/NewMaster.master" AutoEventWireup="false"
    CodeFile="HR_UpdateTransactionsRequestApproval.aspx.vb" Inherits="DailyTasks_HR_UpdateTransactionsRequestApproval"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        function ShowPopUp(Mode) {
            ...
            if (Mode == 1) {
                if (lang == 'en') {
                    ...
                    return confirm('هل انت متأكد من قبول طلب تعديل الحركة؟');
                }
            }
            else if (Mode == 2) {
                if (lang == 'en') {
                    ...
                    return confirm('هل انت متأكد من رفض طلب تعديل الحركة؟');
                }
            }
        }
    ...
    <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0"
        OnClientActiveTabChanged="hideValidatorCalloutTab" Style="visibility: visible" CssClass="" meta:resourcekey="TabContainer1Resource1">
        <cc1:TabPanel ID="tabRequests" runat="server" HeaderText="Update Transaction Requests"
            ...
            <ContentTemplate>
                <asp:MultiView ID="mvManualEntry" runat="server">
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                ...
                                <telerik:RadGrid runat="server" ID="dgrdEntries" AllowSorting="True" AllowPaging="True"
                                    ...
                                    PageSize="25" ShowFooter="True" CellSpacing="0" meta:resourcekey="dgrdEntriesResource1">
                                    <GroupingSettings CaseSensitive="False" />
                                    <ClientSettings EnablePostBackOnRowClick="True" EnableRowHoverStyle="True">
                                        <Selecting AllowRowSelect="True" />
                                    </ClientSettings>
                                    <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False"
                                        DataKeyNames="MoveRequestId,AttachedFile">
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="MoveRequestId" SortExpression="MoveRequestId"
                                                ...
                                                FilterControlAltText="Filter MoveRequestId column" meta:resourcekey="GridBoundColumnResource1" />
                                            ...
                                            <telerik:GridBoundColumn DataField="ReasonName" SortExpression="ReasonName" HeaderText="Reason"
                                                UniqueName="ReasonName" FilterControlAltText="Filter ReasonName column" meta:resourcekey="GridBoundColumnResource4" />
                                            <telerik:GridBoundColumn DataField="MoveDate" SortExpression="MoveDate" HeaderText="Date"
                                                DataFormatString="{0:dd/MM/yyyy}" UniqueName="MoveDate" FilterControlAltText="Filter MoveDate column" meta:resourcekey="GridBoundColumnResource5" />
                                            <telerik:GridBoundColumn DataField="MoveTime" SortExpression="MoveTime" HeaderText="Time"
                                                DataFormatString="{0:HH:mm}" UniqueName="MoveTime" FilterControlAltText="Filter MoveTime column" meta:resourcekey="GridBoundColumnResource6" />
                                            <telerik:GridBoundColumn AllowFiltering="False" DataField="AttachedFile" Visible="False"
                                                UniqueName="AttachedFile" FilterControlAltText="Filter AttachedFile column" meta:resourcekey="GridBoundColumnResource7" />
                                            <telerik:GridTemplateColumn HeaderText="Attached File" AllowFiltering="False" UniqueName="TemplateColumn"
                                                FilterControlAltText="Filter TemplateColumn column" meta:resourcekey="GridTemplateColumnResource1">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridBoundColumn DataField="Remarks" SortExpression="Remarks" HeaderText="Remarks"
                                                UniqueName="Remarks" FilterControlAltText="Filter Remarks column" meta:resourcekey="GridBoundColumnResource8" />
                                            <telerik:GridBoundColumn DataField="IsFromMobile" Visible="False" AllowFiltering="False"
                                                UniqueName="IsFromMobile" FilterControlAltText="Filter IsFromMobile column" meta:resourcekey="GridBoundColumnResource9" />

                                            <telerik:GridBoundColumn DataField="UpdateTransactionTypeEn" HeaderText="Type"
                                                UniqueName="UpdateTransactionTypeEn" FilterControlAltText="Filter UpdateTransactionTypeEn column"
                                                meta:resourcekey="GridBoundColumnResource25" />

                                            <telerik:GridBoundColumn DataField="UpdateTransactionTypeAr" AllowFiltering="False" HeaderText="Type" Visible="False"
                                                UniqueName="UpdateTransactionTypeAr" FilterControlAltText="Filter UpdateTransactionTypeAr column" />
                                            ...
                                            <telerik:GridBoundColumn DataField="UserID" SortExpression="UserID" HeaderText="Created By"
                                                UniqueName="UserID" FilterControlAltText="Filter UserID column" meta:resourcekey="GridBoundColumnResource12" />
                                            <telerik:GridBoundColumn DataField="CREATED_DATE" SortExpression="CREATED_DATE" HeaderText="Created Date"
                                                UniqueName="CREATED_DATE" DataFormatString="{0:dd/MM/yyyy}" FilterControlAltText="Filter CREATED_DATE column" meta:resourcekey="GridBoundColumnResource13" />
                                            ...
                                            <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="TemplateColumn" FilterControlAltText="Filter TemplateColumn column" meta:resourcekey="GridTemplateColumnResource3">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkReject" runat="server" Text="Reject" CommandName="reject"
                                                        OnClick="lnkReject_Click" OnClientClick="return ShowPopUp('2')" CommandArgument='<%# Eval("MoveRequestId") %>' meta:resourcekey="lnkRejectResource1"></asp:LinkButton>
                                                    ...
                                                    <asp:HiddenField ID="hdnUpdateTransactionTypeAr" runat="server" Value='<%# Eval("UpdateTransactionTypeAr")%>' />
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        </Columns>
                                        <CommandItemTemplate>
                    ...
                    <asp:View ID="vManualEntryDetails" runat="server">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <telerik:RadDatePicker ID="RadDatePicker1" runat="server" AutoPostBack="True" Culture="en-US" meta:resourcekey="RadDatePicker1Resource1">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="RadDatePicker1"
                                    Display="None" ErrorMessage="Please Select Date,The Max Date Allowed is Today" meta:resourcekey="RequiredFieldValidator7Resource1"></asp:RequiredFieldValidator><cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender7"
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <asp:Label ID="lblReason" runat="server" CssClass="Profiletitletxt"
                                    Text="Reason" meta:resourcekey="lblReasonResource1"></asp:Label>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <telerik:RadMaskedTextBox ID="rmtToTime2" runat="server" Mask="##:##"
                                    ...
                                    LabelCssClass="" LabelWidth="64px" meta:resourcekey="rmtToTime2Resource1">
                                    <EmptyMessageStyle Resize="None" />
                                    <ReadOnlyStyle Resize="None" />
                                    <FocusedStyle Resize="None" />
                                    <DisabledStyle Resize="None" />
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" Display="None"
                                    ErrorMessage="Please Time" InitialValue="00:00" ControlToValidate="rmtToTime2" meta:resourcekey="RequiredFieldValidator8Resource1"></asp:RequiredFieldValidator><cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender8"
                        ...
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <asp:Button ID="btnAccept" Text="Accept" CssClass="button" runat="server" meta:resourcekey="btnAcceptResource1"></asp:Button><asp:Button ID="btnReject" CssClass="button" Text="Reject" runat="server" meta:resourcekey="btnRejectResource1"></asp:Button><asp:Button ID="btnCancel" runat="server"
                ...
                <div id="divRejectedManual" class="commonPopup" style="display: none">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <asp:TextBox ID="txtRejectedReason" runat="server" TextMode="MultiLine" Height="60px" meta:resourcekey="txtRejectedReasonResource1" />
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-8">
                            <asp:Button ID="btnRejectPOP" runat="server" Text="Reject" CssClass="button" meta:resourcekey="btnRejectPOPResource1" />
                            <asp:Button ID="btnCancelPOP" runat="server" Text="Cancel" CssClass="button" meta:resourcekey="btnCancelPOPResource1" />
                        </div>
                    </div>
                </div>
            </ContentTemplate>
        </cc1:TabPanel>
        <cc1:TabPanel ID="tabRejected" runat="server" HeaderText="Rejected Requests" TabIndex="1" meta:resourcekey="tabRejectedResource1">
            <ContentTemplate>
                <div class="row">
                    <div class="table-responsive">
                        ...
                        <telerik:RadGrid runat="server" ID="dgrdRejectedRequests" AllowSorting="True" AllowPaging="True"
                            GridLines="None" ShowStatusBar="True" AllowMultiRowSelection="True"
                            PageSize="25" ShowFooter="True" CellSpacing="0" meta:resourcekey="dgrdRejectedRequestsResource1">
                            <GroupingSettings CaseSensitive="False" />
                            <ClientSettings EnablePostBackOnRowClick="True" EnableRowHoverStyle="True">
                                <Selecting AllowRowSelect="True" />
                            </ClientSettings>
                            <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn DataField="MoveRequestId" SortExpression="MoveRequestId"
                                        HeaderText="MoveRequestId" Visible="False" AllowFiltering="False" UniqueName="MoveRequestId" FilterControlAltText="Filter MoveRequestId column" meta:resourcekey="GridBoundColumnResource14" />
                                    <telerik:GridBoundColumn DataField="EmployeeNo" SortExpression="EmployeeNo" HeaderText="Employee No"
                                        UniqueName="EmployeeNo" FilterControlAltText="Filter EmployeeNo column" meta:resourcekey="GridBoundColumnResource15" />
                                    <telerik:GridBoundColumn DataField="EmployeeName" SortExpression="EmployeeName" HeaderText="Employee Name"
                                        UniqueName="EmployeeName" FilterControlAltText="Filter EmployeeName column" meta:resourcekey="GridBoundColumnResource16" />
                                    <telerik:GridBoundColumn DataField="ReasonName" SortExpression="ReasonName" HeaderText="Reason"
                                        UniqueName="ReasonName" FilterControlAltText="Filter ReasonName column" meta:resourcekey="GridBoundColumnResource17" />
                                    <telerik:GridBoundColumn DataField="MoveDate" SortExpression="MoveDate" HeaderText="Date"
                                        DataFormatString="{0:dd/MM/yyyy}" UniqueName="MoveDate" FilterControlAltText="Filter MoveDate column" meta:resourcekey="GridBoundColumnResource18" />
                                    <telerik:GridBoundColumn DataField="MoveTime" SortExpression="MoveTime" HeaderText="Time"
                                        DataFormatString="{0:HH:mm}" UniqueName="MoveTime" FilterControlAltText="Filter MoveTime column" meta:resourcekey="GridBoundColumnResource19" />

                                    <telerik:GridBoundColumn DataField="UpdateTransactionTypeEn" SortExpression="UpdateTransactionTypeEn" HeaderText="Type"
                                        UniqueName="UpdateTransactionTypeEn" FilterControlAltText="Filter UpdateTransactionTypeEn column"
                                        meta:resourcekey="GridBoundColumnResource26" />

                                    <telerik:GridBoundColumn DataField="UpdateTransactionTypeAr" SortExpression="UpdateTransactionTypeAr" HeaderText="Type"
                                        UniqueName="UpdateTransactionTypeAr" FilterControlAltText="Filter UpdateTransactionTypeAr column"
                                        AllowFiltering="false" Visible="false" />

                                    <telerik:GridBoundColumn DataField="Remarks" SortExpression="Remarks" HeaderText="Remarks"
                                        UniqueName="Remarks" FilterControlAltText="Filter Remarks column" meta:resourcekey="GridBoundColumnResource20" />

                                    <telerik:GridBoundColumn DataField="IsFromMobile" Visible="False" AllowFiltering="False"
                                        UniqueName="IsFromMobile" FilterControlAltText="Filter IsFromMobile column" meta:resourcekey="GridBoundColumnResource21" />
                                    <telerik:GridBoundColumn DataField="EmployeeArabicName" Visible="False" AllowFiltering="False"
                                        UniqueName="EmployeeArabicName" FilterControlAltText="Filter EmployeeArabicName column" meta:resourcekey="GridBoundColumnResource22" />
                                    <telerik:GridBoundColumn DataField="ReasonArabicName" Visible="False" UniqueName="ReasonArabicName"
                                        AllowFiltering="False" FilterControlAltText="Filter ReasonArabicName column" meta:resourcekey="GridBoundColumnResource23" />
                                    <telerik:GridBoundColumn AllowFiltering="False" DataField="RejectionReason" HeaderText="Rejection Reason"
                                        UniqueName="RejectionReason" FilterControlAltText="Filter RejectionReason column" meta:resourcekey="GridBoundColumnResource24">
                                ...
                                <CommandItemTemplate>
                                    <telerik:RadToolBar runat="server" ID="RadToolBar2" OnButtonClick="RadToolBar2_ButtonClick"
                                        ...
                                        <Items>
                                            <telerik:RadToolBarButton Text="Apply filter" CommandName="FilterRadGrid" ImageUrl="~/images/RadFilter.gif"
                                                ImagePosition="Right" runat="server" Owner="" meta:resourcekey="RadToolBarButtonResource2" />
                                        </Items>
                                    </telerik:RadToolBar>
                                </CommandItemTemplate>

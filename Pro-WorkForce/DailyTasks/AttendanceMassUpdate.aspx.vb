...
Partial Class DailyTasks_AttendanceMassUpdate
...
#Region "Class Variables"
    ...
    Private sUser As String = String.Empty
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        sUser = SessionVariables.LoginUser.UsrID
            ...
            For Each item As ListItem In cblEmpList.Items
                If item.Selected Then
                    ...
                    If tbl_id = 0 Then
                        err = objEmpMove.Add()
                    Else
                        objEmpMove.LAST_UPDATE_BY = sUser

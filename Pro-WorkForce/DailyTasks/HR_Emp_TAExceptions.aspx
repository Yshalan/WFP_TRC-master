<%@ Page Title="" Language="VB" Theme="SvTheme" MasterPageFile="~/Default/NewMaster.master" AutoEventWireup="false"
    CodeFile="HR_Emp_TAExceptions.aspx.vb" Inherits="Definitions_HR_Emp_TAExceptions" meta:resourcekey="PageResource1" uiculture="auto" %>
        ...
        <ContentTemplate>
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:CheckBox ID="chckTemporary" Text="&nbsp;" runat="server" AutoPostBack="True" 
                           />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-8 text-center">
                            ...
                            <asp:Button ID="btnDelete" runat="server" Text="Delete" Width="110px" 
                                CssClass="button" meta:resourcekey="btnDeleteResource1"
                                />
                            <asp:Button ID="btnClear" runat="server" Text="Clear" Width="110px" 
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="ToDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="To Date"
                                      ...
                                      <telerik:GridBoundColumn DataField="IsRejected" HeaderText="Status"
                                        UniqueName="IsRejected" meta:resourcekey="GridBoundColumnResource7" />
                                </Columns>
                                <CommandItemTemplate>

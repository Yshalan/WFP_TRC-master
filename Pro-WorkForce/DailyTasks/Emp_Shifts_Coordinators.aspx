<%@ Page Title="" Language="VB" Theme="SvTheme" MasterPageFile="~/Default/NewMaster.master"
    AutoEventWireup="false" CodeFile="Emp_Shifts_Coordinators.aspx.vb" Inherits="Admin_Emp_Shifts_Coordinators"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <asp:Literal runat="server" ID="JSON_Details" meta:resourcekey="JSON_DetailsResource1" />
    <script src="../js/ScheduleGroupShift4.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-md-2">
            <asp:Label runat="server" ID="lblWorkSchedule" CssClass="Profiletitletxt" Text="Work Schedule" meta:resourcekey="lblWorkScheduleResource1" />
        </div>
        <div class="col-md-4">
            <asp:DropDownList runat="server" ID="ddlWorkSchedule" AppendDataBoundItems="True"
                DataTextField="ScheduleName" DataValueField="ScheduleId" onchange="ddlWorkSchedule_changed(this.options[this.selectedIndex].value);" meta:resourcekey="ddlWorkScheduleResource1">
            ...
            <asp:RequiredFieldValidator ID="rfvWorkSchedule" runat="server" Display="None" ErrorMessage="Please Select Work Schedule"
                ControlToValidate="ddlWorkSchedule" InitialValue="0" ValidationGroup="WorkSchedule" meta:resourcekey="rfvWorkScheduleResource1"></asp:RequiredFieldValidator>
    ...
    <div class="row" runat="server" id="divShift">
        <div class="col-md-2">
            <asp:Label runat="server" ID="lblShift" CssClass="Profiletitletxt" Text="Shift" Style="float: left" meta:resourcekey="lblShiftResource1" />
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-2">
            <asp:Label runat="server" ID="lblEmpNo" CssClass="Profiletitletxt" Text="Employee No."
                Visible="False" meta:resourcekey="lblEmpNoResource1" />
        </div>
        <div class="col-md-4">
    ...
    <div id="divControls" runat="server" class="row">
        <div class="col-md-12 text-center">
            ...
            <img id="imgLoading" src="../images/loading.gif" style="width: 25px; height: 25px; display: none;" />
        </div>
    </div>
    <script type="text/javascript">

<%@ Control Language="VB" AutoEventWireup="false" CodeFile="AssignSchedule_LogicalGroup.ascx.vb"
    Inherits="DailyTasks_UserControls_AssignSchedule_LogicalGroup" %>
...
<%--<center>
    <uc1:PageHeader ID="Assign_LogicalGrp" runat="server" />
</center>--%>
    <%--  <tr>
        <td>
            <asp:Label ID="lblCompany" runat="server" CssClass="Profiletitletxt" Text="Compnay"></asp:Label>
        </td>
        <td>
            <telerik:RadComboBox ID="RadCmbBxCompany" MarkFirstMatch="True" Skin="Vista" runat="server" AutoPostBack="true">
            </telerik:RadComboBox>
        </td>
        <td>
            <asp:RequiredFieldValidator ID="RFVCompany" ValidationGroup="grpSave_LogicalGrp"
                InitialValue="--Please Select--" runat="server" ControlToValidate="RadCmbBxCompany"
    ...
    <div class="row">
        <div class="col-md-2">
            <asp:Label ID="lblLogicalGroup" runat="server" CssClass="Profiletitletxt" Text="Logical Group"
        ...
        <div class="col-md-4">
            ...
            <asp:RequiredFieldValidator ID="RFVLogic_Group" ValidationGroup="grpSave_LogicalGrp"
                InitialValue="--Please Select--" runat="server" ControlToValidate="RadCmbBxLogicalGroup"
                Display="None" ErrorMessage="Please Select Logical Group" meta:resourcekey="rfvScheduleResource1"></asp:RequiredFieldValidator>
            <cc1:ValidatorCalloutExtender ID="VCELogic_Group" runat="server" CssClass="AISCustomCalloutStyle"
                TargetControlID="RFVLogic_Group" WarningIconImageUrl="~/images/warning1.png"
                Enabled="True">
            </cc1:ValidatorCalloutExtender>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <asp:RequiredFieldValidator ID="rfvScheduletype" ValidationGroup="grpSave_LogicalGrp"
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <asp:RequiredFieldValidator ID="rfvSchedule" ValidationGroup="grpSave_LogicalGrp"
                InitialValue="--Please Select--" runat="server" ControlToValidate="RadCmbBxSchedules"
                Display="None" ErrorMessage="Please Select Schedule" meta:resourcekey="rfvRadCmbBxSchedulesResource"></asp:RequiredFieldValidator>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <telerik:RadDatePicker ID="dtpFromdate" runat="server" AllowCustomText="false" MarkFirstMatch="true"
              ...
              <asp:RequiredFieldValidator ID="rfvdtpFromDate" ValidationGroup="grpSave_LogicalGrp"
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <telerik:RadDatePicker ID="dtpEndDate" runat="server" AllowCustomText="false" MarkFirstMatch="true"
                 ...
                 <asp:RequiredFieldValidator ID="rfvdtpEndDate" ValidationGroup="grpSave_LogicalGrp"
    ...
    <div class="row" id="trControls" runat="server">
        <div class="col-md-12 text-center">
                <asp:Button ID="btnSave" runat="server" Text="Assign Schedule" ValidationGroup="grpSave_LogicalGrp"
    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <div class="filterDiv">
                <telerik:RadFilter runat="server" ID="RadFilter1" Skin="Hay" FilterContainerID="dgrdSchedule_LogicalGroup"
                    ShowApplyButton="False" CssClass="RadFilter RadFilter_Default " meta:resourcekey="RadFilter1Resource1" />
            </div>
            <telerik:RadGrid runat="server" ID="dgrdSchedule_LogicalGroup" AutoGenerateColumns="false"
                PageSize="15"  AllowPaging="true" AllowSorting="true" AllowFilteringByColumn="false"
                GroupingSettings-CaseSensitive="false">
                <MasterTableView IsFilterItemExpanded="true" CommandItemDisplay="Top" AllowFilteringByColumn="false" DataKeyNames="EmpWorkScheduleId,GroupId,ScheduleId">
                    <CommandItemTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="GroupId" HeaderText="CompnayId" SortExpression="CompnayId"
                            Visible="false">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="GroupArabicName" HeaderText="Group Arabic Name"
                            SortExpression="GroupArabicName" meta:resourcekey="GridBoundColumn2Resource1">
                        </telerik:GridBoundColumn>

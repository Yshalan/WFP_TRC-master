...
<div style="padding: 20px 20px 20px 20px">
    <telerik:RadFilter Skin="Windows7" runat="server" ID="RadFilter1" FilterContainerID="dgrdAschedule"
        ShowApplyButton="false" />
    <telerik:RadGrid ID="dgrdAschedule" runat="server" AllowSorting="True" AllowPaging="True" PageSize="25"
        Skin="Windows7" GridLines="None" ShowStatusBar="True" AllowMultiRowSelection="True" GroupingSettings-CaseSensitive="false"
        ShowFooter="True">
        <SelectedItemStyle ForeColor="maroon" />
        <MasterTableView AllowMultiColumnSorting="True" IsFilterItemExpanded="True" CommandItemDisplay="Top"
            AutoGenerateColumns="False">
            <CommandItemTemplate>
                <telerik:RadToolBar Skin="Windows7" runat="server" ID="RadToolBar1" OnButtonClick="RadToolBar1_ButtonClick">
                    <Items>

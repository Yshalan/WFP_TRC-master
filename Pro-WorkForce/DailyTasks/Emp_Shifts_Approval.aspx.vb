    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                Lang = CtlCommon.Lang.EN
            End If
            PageHeader1.HeaderText = ResourceManager.GetString("EmpShiftsApprove", CultureInfo)
...
#Region "Methods"
    ...
    Private Sub FillSchedule()
        ...
        Else
            ...
            Else
                ScriptManager.RegisterStartupScript(Me, Page.GetType, "Script", "ddlWorkSchedule_changed(ctl00_ContentPlaceHolder1_ddlWorkSchedule.options[ctl00_ContentPlaceHolder1_ddlWorkSchedule.selectedIndex].value)" & rblFilerSelection.SelectedValue & ";", True)
                Exit Sub
            End If

<%@ Page Title="" Language="VB" Theme="SvTheme" MasterPageFile="~/Default/NewMaster.master"
    AutoEventWireup="false" CodeFile="Emp_Shifts_Approval.aspx.vb" Inherits="Admin_Emp_Shifts_Request"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../js/ScheduleShiftApprove.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="divControls" runat="server" class="row">
        <div class="col-md-12 text-center">
            <asp:Button runat="server" ID="btnSave" Text="Save" OnClientClick="PostData($('#ctl00_ContentPlaceHolder1_rblFilerSelection').find('input:checked').val()); return false;"

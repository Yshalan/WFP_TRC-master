<%@ Page Language="VB" AutoEventWireup="false" Theme="SvTheme" MasterPageFile="~/Default/NewMaster.master"
    CodeFile="OvertimeRulesMassUpdate.aspx.vb" Inherits="Admin_OvertimeRulesMassUpdate"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <uc1:PageHeader ID="PageHeader1" runat="server" HeaderText="OverTime Rules Mass Update" />
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-2">
                    <asp:Label ID="lblOverTime" runat="server" CssClass="Profiletitletxt" Text="OverTime Rules"
                        meta:resourcekey="lblOverTimeResource1"></asp:Label>
                </div>
                <div class="col-md-4">
                    <telerik:RadComboBox ID="RadCmbBxRules" MarkFirstMatch="True" Skin="Vista" runat="server"
                        meta:resourcekey="RadCmbBxRulesResource1">
                    </telerik:RadComboBox>
                    <asp:RequiredFieldValidator ID="rfvRules" ValidationGroup="grpSave" InitialValue="--Please Select--"
                        runat="server" ControlToValidate="RadCmbBxRules" Display="None" ErrorMessage="Please Select OverTime Rule"
                        meta:resourcekey="rfvRulesResource1"></asp:RequiredFieldValidator>
                    <cc1:ValidatorCalloutExtender ID="vceRules" runat="server" CssClass="AISCustomCalloutStyle"
                        TargetControlID="rfvRules" WarningIconImageUrl="~/images/warning1.png" Enabled="True">
                    </cc1:ValidatorCalloutExtender>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <asp:CheckBox ID="chckTemporary" runat="server" AutoPostBack="True" ext="Is Temporary"
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <asp:Button ID="btnSave" runat="server" Text="Assign Overtime Rule" ValidationGroup="grpSave"

<%@ Page Title="" Language="VB" Theme="SvTheme" MasterPageFile="~/Default/NewMaster.master"
    AutoEventWireup="false" CodeFile="ManualEntryMassUpdate.aspx.vb" Inherits="DailyTasks_ManualEntryMassUpdate"
                ...
                <div class="col-md-4">
                    <asp:CustomValidator ID="cvEmpListValidation" ErrorMessage="please select at least one employee"
                        ValidationGroup="ReasonValidation" ForeColor="Black" runat="server" CssClass="customValidator"
                         ...
                         meta:resourcekey="cvEmpListValidationResource1" />    <%--ClientValidationFunction="CheckBoxListSelect"--%>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <telerik:RadMaskedTextBox ID="rmtToTime2" runat="server" Mask="##:##" TextWithLiterals="00:00"
                        CssClass="RadMaskedTextBox" Text='<%# DataBinder.Eval(Container,"DataItem.ToTime2") %>'
                        DisplayMask="##:##" LabelCssClass="" meta:resourcekey="rmtToTime2Resource1">
                    </telerik:RadMaskedTextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" Display="None"
                        ErrorMessage="Please Time" ControlToValidate="rmtToTime2" meta:resourcekey="RequiredFieldValidator8Resource1"
                        ValidationGroup="ReasonValidation"></asp:RequiredFieldValidator>
                        ...
                        <MasterTableView AllowMultiColumnSorting="True" CommandItemDisplay="Top">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="MoveTime" SortExpression="M_Time" HeaderText="Time"
                                    DataFormatString="{0:HH:mm}" meta:resourcekey="BoundFieldResource3" UniqueName="MoveTime" />

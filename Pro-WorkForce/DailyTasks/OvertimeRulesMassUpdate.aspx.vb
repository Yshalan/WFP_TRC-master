...
Partial Class Admin_OvertimeRulesMassUpdate
...
#Region "Page Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            PageHeader1.HeaderText = ResourceManager.GetString("OverMassUpdate", CultureInfo)
            rfvRules.InitialValue = ResourceManager.GetString("PleaseSelect", CultureInfo)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If RadCmbBxRules.SelectedValue <> -1 Then
            ...
            For Each item As ListItem In cblEmpList.Items
                If item.Selected = True Then
                    ...
                    objEmp_OverTimeRule.FK_EmployeeId = item.Value
                    objEmp_OverTimeRule.FK_RuleId = RadCmbBxRules.SelectedValue
                    objEmp_OverTimeRule.FromDate = dtpFromdate.SelectedDate
                    objEmp_OverTimeRule.ToDate = IIf(dtpEndDate.SelectedDate Is Nothing Or Not chckTemporary.Checked, DateTime.MinValue, dtpEndDate.SelectedDate)
                    objEmp_OverTimeRule.CREATED_BY = "1"
                    objEmp_OverTimeRule.CREATED_DATE = Date.Now
                    objEmp_OverTimeRule.LAST_UPDATE_BY = "1"
                    objEmp_OverTimeRule.LAST_UPDATE_DATE = Date.Now

                    errornum = objEmp_OverTimeRule.AssignTAPolicy()
...
#Region "Methods"
    ...
    Private Sub FillOverTimeRules()
        Dim objOvertimeRules As New OvertimeRules
        CtlCommon.FillTelerikDropDownList(RadCmbBxRules, objOvertimeRules.GetAll, Lang)
    End Sub

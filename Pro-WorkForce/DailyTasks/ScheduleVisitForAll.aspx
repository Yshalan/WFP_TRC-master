<%@ Page Language="VB" AutoEventWireup="false" Theme="SvTheme" UICulture="auto"
    CodeFile="ScheduleVisitForAll.aspx.vb" Inherits="SelfServices_ScheduleVisit" MasterPageFile="~/Default/NewMaster.master" Culture="auto" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <uc2:PageFilter ID="empfilter" runat="server" />
    <hr />
    <div class="row">
        <%--<div class="col-md-2">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <asp:Label CssClass="Profiletitletxt" ID="lblEid" runat="server" Text="National Number" meta:resourcekey="lblEidResource1"></asp:Label>
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <asp:RequiredFieldValidator ID="reqddlreason" runat="server" ControlToValidate="ddlreason" InitialValue="--Please Select--"
                Display="None" ErrorMessage="Please Select Visit Reason" ValidationGroup="grpSave" meta:resourcekey="reqddlreasonResource1"></asp:RequiredFieldValidator>
        ...
        <div class="col-md-4">
            <telerik:RadDatePicker ID="dtpVisitDate" runat="server" AllowCustomText="false" MarkFirstMatch="true"
                PopupDirection="TopRight" ShowPopupOnFocus="True" Skin="Vista" Culture="en-US"
                meta:resourcekey="dtpVisitDateResource1">
                <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" ViewSelectorText="x">
                </Calendar>
                <DateInput DateFormat="dd/MM/yyyy" DisplayDateFormat="dd/MM/yyyy" LabelCssClass=""
                    Width="" LabelWidth="64px">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <asp:RequiredFieldValidator ID="reqFromtime" runat="server" ControlToValidate="RadTPfromTime"
                Display="None" ErrorMessage="Please Select Start Time" ValidationGroup="grpSave" meta:resourcekey="reqFromtimeResource1"></asp:RequiredFieldValidator>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <asp:Button ID="btnSave" runat="server" Text="Save" meta:resourcekey="btnSaveResource1" ValidationGroup="grpSave" />
    ...
    <div class="table-responsive">
        ...
        <telerik:RadGrid ID="grdVisitDetails" runat="server" AllowSorting="True" AllowPaging="True"
            ...
            <MasterTableView AllowMultiColumnSorting="True" AutoGenerateColumns="False" CommandItemDisplay="Top"
               ...
               <%--     <telerik:GridBoundColumn DataField="VisitorName"
                        UniqueName="VisitorName" meta:resourcekey="GridBoundColumnResource1">
                    </telerik:GridBoundColumn>--%>
                    <telerik:GridBoundColumn DataField="VisitorArabicName"
